...
d=0;d<a.length;d++)a[d]<b&&(b=parseFloat(a[d])),a[d]>c&&(c=parseFloat(a[d]));return[b,c]}},Colors=new function(){function a(){var b=0,c=0,d=0,e=0,f=0,g=0;this.SetRGB=function(a,k,h){b=a/255;c=k/255;d=h/255;a=Math.max(Math.max(b,c),d);k=Math.min(Math.min(b,c),d);g=a;f=0;0!=a&&(f=1-k/a);e=0;k!=a&&(k=a-k,e=b==a?(c-d)/k:c==a?2+(d-b)/k:4+(b-c)/k,e*=60,0>e&&(e+=360))};this.Red=function(){return Math.round(255*b)};this.Green=function(){return Math.round(255*c)};this.Blue=function(){return Math.round(255*
d)};this.SetHSV=function(a,k,h){e=a;f=k;g=h;d=c=b=g;if(!(0==g||0==f)){var k=e/60,a=Math.floor(k),l=k-a,k=g*(1-f),h=g*(1-f*l),l=g*(1-f*(1-l));switch(a){case 0:b=g;c=l;d=k;break;case 1:b=h;c=g;d=k;break;case 2:b=k;c=g;d=l;break;case 3:b=k;c=h;d=g;break;case 4:b=l;c=k;d=g;break;default:b=g,c=k,d=h}}};this.Hue=function(){return e};this.Saturation=function(){return f};this.Value=function(){return g};this.SetHexString=function(a){if(null==a||"string"!=typeof a)this.SetRGB(0,0,0);else if("#"==a.substr(0,
...
ResultWidget.prototype.drawHistograms=function(){for(id in this.resultHistograms){var a=new OpencgaManager;a.onPoll.addEventListener(function(a,c){if(""!=c){for(var d=c.split("\n"),e=[],f=[],g=[],j=[],k=0,h=0;h<d.length;h++)e.push(d[h].split("\t")),""!=e[h][0]&&f.push(e[h][0]),null!=e[h][1]&&(k+=parseFloat(e[h][1]),g.push(e[h][1]));for(h=0;h<g.length;h++)j.push(Math.round(100*(parseFloat(g[h])/k)));f=f.toString().replace(/,/gi,"|");document.getElementById(id).innerHTML='<img src="https://chart.googleapis.com/chart?cht=p&chs=600x300&chd=t:'+
j+"&chl="+f+'&chtt=Consequence+types&chts=000000,14.5">'}});a.poll($.cookie("bioinfo_account"),$.cookie("bioinfo_sid"),this.jobId,this.resultHistograms[id],!1)}};ResultWidget.prototype.drawGCharts=function(){for(id in this.resultGCharts)drawChart(id,this.resultGCharts[id])};
...
nodesMinSize:2});g.dataBind(e);f.dataBind(e);g.setHeight(d-140);g.setWidth(c-2-13);this.networkViewer.drawNetwork(e,g,f);c=new WumRestAdapter;c.onPoll.addEventListener(function(c,d){for(var e=d.split("\n"),f=[],g=1;g<e.length;g++){var p=13;"fatiscan"==record.data.toolName&&7==e[g].split("\t").length&&(p=6);1E6>e[g].split("\t")[p]&&f.push(e[g].split("\t")[0])}console.log("significativesFeatures.length: "+f.length);e=new WumRestAdapter;e.onPoll.addEventListener(function(c,d){var e=d.split("\n");e.pop();
...
ResultWidget.prototype.loadNetworkOnCellBrowser=function(a,b,c){var d=this,e=0,f=new CellBaseManager(this.networkViewer.species);f.success.addEventListener(function(f,j){for(var k=j.result,h={},l=0;l<k.length;l++)for(var m=0;m<k[l].length;m++)-1!=b.toString().indexOf(k[l][m].tfName)&&(null==h[k[l][m].tfName]&&(h[k[l][m].tfName]={}),null==h[k[l][m].tfName][a[l]]&&(h[k[l][m].tfName][a[l]]=!0));console.log(h);console.log(k.length);console.log("contando TFBSs...");var k=0,p;for(p in h){if(500<k)break;
for(var o in h[p])k++}console.log("menos de 500: "+k);for(p in h)for(o in d.networkViewer.networkWidget.getDataset().addNode(p,{type:"tf"}),l=d.networkViewer.networkWidget.getDataset().getVerticesCount()-1,d.networkViewer.networkWidget.getFormatter().getVertexById(l).getDefault().setFill("#DF0101"),h[p])if(500>k||!0==mostSignificativesFeatures[o])0==d.networkViewer.networkWidget.getDataset().getVertexByName(o).length&&d.networkViewer.networkWidget.getDataset().addNode(o,{type:"gene"}),l=d.networkViewer.networkWidget.getDataset().getVertexByName(o)[0].id,
m=d.networkViewer.networkWidget.getDataset().getVertexByName(p)[0].id,d.networkViewer.networkWidget.getDataset().addEdge("tfbs_"+l+"_"+m,m,l),d.networkViewer.networkWidget.getFormatter().getVertexById(l).getDefault().setFill("#0000FF");d.networkViewer.networkWidget.getLayout().getLayout("neato");d.networkViewer.networkWidget.getLayout().layoutDone.addEventListener(function(){e++;2==e&&(Ext.getCmp(d.id+"pbar").destroy(),Ext.getCmp(d.application+c).enable())})});0<a.length&&f.get("feature","gene",a,
"tfbs");f=new CellBaseManager(this.networkViewer.species);f.success.addEventListener(function(f,j){for(var k=j.result,h={},l=0;l<k.length;l++)for(var m=0;m<k[l].length;m++)-1!=b.toString().indexOf(k[l][m].mirbaseId)&&(null==h[k[l][m].mirbaseId]&&(h[k[l][m].mirbaseId]={}),null==h[k[l][m].mirbaseId][a[l]]&&(h[k[l][m].mirbaseId][a[l]]=!0));console.log(h);console.log(k.length);console.log("contando miRNAs...");var k=0,p;for(p in h){if(500<k)break;for(var o in h[p])k++}console.log("menos de 500: "+k);
for(var n in h)for(o in d.networkViewer.networkWidget.getDataset().addNode(n,{type:"mirna"}),p=d.networkViewer.networkWidget.getDataset().getVerticesCount()-1,d.networkViewer.networkWidget.getFormatter().getVertexById(p).getDefault().setFill("red"),h[n])if(500>k||!0==mostSignificativesFeatures[o])0==d.networkViewer.networkWidget.getDataset().getVertexByName(o).length&&d.networkViewer.networkWidget.getDataset().addNode(o,{type:"gene"}),p=d.networkViewer.networkWidget.getDataset().getVertexByName(o)[0].id,
l=d.networkViewer.networkWidget.getDataset().getVertexByName(n)[0].id,d.networkViewer.networkWidget.getDataset().addEdge("tfbs_"+p+"_"+l,l,p),d.networkViewer.networkWidget.getFormatter().getVertexById(p).getDefault().setFill("blue"),p=d.networkViewer.networkWidget.getDataset().getEdgesCount()-1,d.networkViewer.networkWidget.getFormatter().changeEdgeType(p,"CutDirectedLineEdgeNetworkFormatter");d.networkViewer.networkWidget.getLayout().getLayout("neato");d.networkViewer.networkWidget.getLayout().layoutDone.addEventListener(function(){e++;
...
Utils.images.r);for(var g=c,j=0;j<f.length;j++){var k;a:{for(k=0;k<g.length;k++)if(g[k].text==f[j])break a;k=-1}if(-1!=k)g=g[k].children;else{k=[];var h=g.push({text:f[j],children:k})-1;if("undefined"==typeof f[j+1])for(key in e)"children"!=key&&(g[h][key]=e[key]);g=k}}}c=JSON.stringify(c);this.allStore.getRootNode().appendChild({text:this.accountData.buckets[b].name,bucketId:this.accountData.buckets[b].name,oid:"",icon:Utils.images.bucket,expanded:!0,isBucket:!0,children:JSON.parse(c)});this.folderStore.getRootNode().appendChild({text:this.accountData.buckets[b].name,
bucketId:this.accountData.buckets[b].name,oid:"",icon:Utils.images.bucket,expanded:!0,isBucket:!0,children:JSON.parse(c)})}}if(null!=this.selectedTreeNode&&(b=this.allStore.getRootNode().findChild(this.selectedTreeNode.field,this.selectedTreeNode.value,!0),null!=b)){var l=[];b.eachChild(function(b){a.checkTags(b.raw.fileFormat)&&l.push(b.raw)});a.filesGrid.setTitle(b.getPath("text"," / "));a.filesStore.loadData(l)}}};
...
b.setTrackIndex(d.data.trackId,d.data.index)}}},listeners:{itemclick:function(c,d){var e,f;null!=d.raw.isBucket?(e="text",f=!1):(e="oid",f=!0);f=b.allStore.getRootNode().findChild(e,d.raw[e],f);var l=[];b.selectedTreeNode={value:f.data[e],field:e};f.eachChild(function(a){b.checkTags(a.raw.fileFormat)&&l.push(a.raw)});b.filesGrid.setTitle(f.getPath("text"," / "));b.filesStore.loadData(l);"folderSelection"==a&&(b.lastSelectedNode=f.raw,b.selectButton.enable())},checkchange:function(){},itemmouseenter:function(){},
...
protein_coding:"#a00000",pseudogene:"#666666",retained_intron:"gold",retrotransposed:"lightsalmon",rRNA:"indianred",sense_intronic:"#20B2AA",sense_overlapping:"#20B2AA",snoRNA:"#8b668b",snRNA:"#8b668b",transcribed_processed_pseudogene:"#666666",transcribed_unprocessed_pseudogene:"#666666",unitary_pseudogene:"#666666",unprocessed_pseudogene:"#666666","":"orangered",other:"#000000"};
...
a.description+"</span><br>"+FEATURE_TYPES.getTipCommons(a)},getColor:function(a){return GENE_BIOTYPE_COLORS[a.biotype]},infoWidgetId:"stableId",height:1,histogramColor:"lightblue"},exon:{getLabel:function(a){return a=""+a.stableId},getTipTitle:function(a){return FEATURE_TYPES.formatTitle(a.exon.featureType)+' - <span class="ok">'+a.exon.stableId+"</span>"},getTipText:function(a,b){return'transcript name:&nbsp;<span class="ssel">'+b.externalName+'</span><br>transcript Ensembl&nbsp;ID:&nbsp;<span class="ssel">'+
...
"$1,")+"</span><br>"},getColor:function(){return"black"},infoWidgetId:"stableId",height:5,histogramColor:"lightblue"},snp:{getLabel:function(a){return a.name},getTipTitle:function(a){return a.featureType.toUpperCase()+' - <span class="ok">'+a.name+"</span>"},getTipText:function(a){return'alleles:&nbsp;<span class="ssel">'+a.alleleString+'</span><br>ancestral allele:&nbsp;<span class="ssel">'+a.ancestralAllele+'</span><br>SO consequence:&nbsp;<span class="emph" style="color:'+SNP_BIOTYPE_COLORS[a.displaySoConsequence]+
';">'+a.displaySoConsequence+"</span><br>"+FEATURE_TYPES.getTipCommons(a)+'source:&nbsp;<span class="ssel">'+a.source+"</span><br>"},getColor:function(a){return SNP_BIOTYPE_COLORS[a.displaySoConsequence]},infoWidgetId:"name",height:8,histogramColor:"orange"},cpg_island:{getLabel:function(a){return a.name},getTipTitle:function(a){return'CpG island - <span class="ok">'+a.name+"</span>"},getTipText:function(a){return'CpG number:&nbsp;<span class="ssel">'+a.cpgNum+'</span><br>CpG precentage:&nbsp;<span class="ssel">'+
...
a.sumSquarePrimate+"</span><br>"+FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"DodgerBlue"},infoWidgetId:"name",height:8,histogramColor:"DodgerBlue"},file:{getLabel:function(a){return a=""+a.label},getTipTitle:function(a){return FEATURE_TYPES.formatTitle(a.featureType)},getTipText:function(a){return FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"black"},height:8,histogramColor:"orange"},vcf:{getLabel:function(a){return a.id},getTipTitle:function(a){return'VCF variant - <span class="ok">'+
a.id+"</span>"},getTipText:function(a){return'alleles (ref/alt):&nbsp;<span class="emph">'+a.reference+"/"+a.alternate+'</span><br>quality:&nbsp;<span class="emph">'+a.quality+'</span><br>filter:&nbsp;<span class="emph">'+a.filter+"</span><br>"+FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"black"},infoWidgetId:"id",height:8,histogramColor:"gray"},gff2:{getLabel:function(a){return a=""+a.label},getTipTitle:function(a){return a.featureType.toUpperCase()+' - <span class="ok">'+a.label+"</span>"},
getTipText:function(a){return'score:&nbsp;<span class="emph">'+a.score+'</span><br>frame:&nbsp;<span class="emph">'+a.frame+"</span><br>"+FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"black"},height:8,histogramColor:"gray"},gff3:{getLabel:function(a){return a=""+a.label},getTipTitle:function(a){return a.featureType.toUpperCase()+' - <span class="ok">'+a.label+"</span>"},getTipText:function(a){return'score:&nbsp;<span class="emph">'+a.score+'</span><br>frame:&nbsp;<span class="emph">'+
a.frame+"</span><br>"+FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"black"},height:8,histogramColor:"gray"},gtf:{getLabel:function(a){return a=""+a.label},getTipTitle:function(a){return a.featureType.toUpperCase()+' - <span class="ok">'+a.label+"</span>"},getTipText:function(a){return'score:&nbsp;<span class="emph">'+a.score+'</span><br>frame:&nbsp;<span class="emph">'+a.frame+"</span><br>"+FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"black"},height:8,histogramColor:"gray"},
bed:{getLabel:function(a){return a=""+a.label},getTipTitle:function(a){return FEATURE_TYPES.formatTitle(a.featureType)},getTipText:function(a){return FEATURE_TYPES.getTipCommons(a)},getColor:function(a){var b=[],b=a.itemRgb.split(","),a=function(a){var b="0123456789abcdef".split("");return isNaN(a)?"00":b[(a-a%16)/16]+b[a%16]};return"#"+(a(b[0])+a(b[1])+a(b[2]))},height:8,histogramColor:"orange"},bam:{explainFlags:function(a){for(var b='<div style="background:#FFEF93;font-weight:bold;margin:0 15px 0 0;">flags : <span class="ssel">'+
a+"</span></div>",c=0;c<SAM_FLAGS.length;c++)SAM_FLAGS[c][1]&a&&(b+=SAM_FLAGS[c][0]+"<br>");return b},getLabel:function(a){return"bam  "+a.chromosome+":"+a.start+"-"+a.end},getTipTitle:function(a){return FEATURE_TYPES.formatTitle(a.featureType)+' - <span class="ok">'+a.name+"</span>"},getTipText:function(a){a.strand=FEATURE_TYPES.bam.getStrand(a);var b='cigar:&nbsp;<span class="ssel">'+a.cigar+'</span><br>insert size:&nbsp;<span class="ssel">'+a.inferredInsertSize+"</span><br>"+FEATURE_TYPES.getTipCommons(a)+
"<br>"+this.explainFlags(a.flags),c='<div style="background:#FFEF93;font-weight:bold;">attributes</div>';delete a.attributes.BQ;for(var d in a.attributes)c+=d+":"+a.attributes[d]+"<br>";return'<div style="float:left">'+b+'</div><div style="float:right">'+c+"</div>"},getColor:function(a,b){return a.mateReferenceName!=b?"lightgreen":0==(parseInt(a.flags)&16)?"DarkGray":"LightGray"},getStrokeColor:function(a){return this.getMateUnmappedFlag(a)?"tomato":"whitesmoke"},getStrand:function(a){return 0==(parseInt(a.flags)&
16)?"Forward":"Reverse"},getReadPairedFlag:function(a){return 0==(parseInt(a.flags)&1)?!1:!0},getFirstOfPairFlag:function(a){return 0==(parseInt(a.flags)&64)?!1:!0},getMateUnmappedFlag:function(a){return 0==(parseInt(a.flags)&8)?!1:!0},height:10,histogramColor:"grey"},das:{getLabel:function(a){return a=""+a.id},getTipTitle:function(a){return FEATURE_TYPES.formatTitle(a.featureType)},getTipText:function(a){return FEATURE_TYPES.getTipCommons(a)},getColor:function(){return"black"},height:8,histogramColor:"orange"}};
...
GenomeViewer.prototype.setRegion=function(a){switch(a.sender){case "setSpecies":this._calculateZoomByRegion();this.species=a.species;this.speciesName=a.name;Ext.example.msg("Species",this.speciesName+" selected.");Ext.getCmp(this.id+"speciesMenuButton").setText(this.speciesName);Ext.getCmp(this.id+"chromosomeMenuButton").setText("Chromosome "+this.region.chromosome);Ext.getCmp(this.id+"chromosomePanel").setTitle("Chromosome "+this.region.chromosome);Ext.getCmp(this.id+"tbCoordinate").setValue(this.region.toString());
...
this.trackSvgLayout.setRegion({});this.trackSvgLayoutOverview.setRegion({});this.chromosomeWidget.setRegion({});this.karyotypeWidget.setRegion({});Ext.getCmp(this.id+"container").setLoading();break;default:this._calculateZoomByRegion(),null!=a.species&&(this.species=a.species,this.speciesName=a.name,Ext.example.msg("Species",this.speciesName+" selected."),this.onSpeciesChange.notify()),Ext.getCmp(this.id+"chromosomeMenuButton").setText("Chromosome "+this.region.chromosome),Ext.getCmp(this.id+"chromosomePanel").setTitle("Chromosome "+
...
GenomeViewer.prototype._getNavigationBar=function(){var a=this,b=Ext.create("Ext.data.Store",{fields:["xrefId","displayId","description"]}),c=Ext.create("Ext.form.field.ComboBox",{id:this.id+"quickSearch",displayField:"displayId",valueField:"displayId",emptyText:"Quick search: gene, snp",hideTrigger:!0,width:150,store:b,queryMode:"local",typeAhead:!1,autoSelect:!1,queryDelay:500,listeners:{change:function(){var c=this.getValue(),e=2;c&&"ENS"==c.substring(0,3).toUpperCase()&&(e=10);c&&c.length>e&&
$.ajax({url:(new CellBaseManager).host+"/latest/"+a.species+"/feature/id/"+this.getValue()+"/starts_with?of=json",success:function(a){a=JSON.parse(a);b.loadData(a[0]);console.log(b)},error:function(a,b){console.log(b)}})},select:function(){a._handleNavigationBar("GoToGene")}}});return Ext.create("Ext.toolbar.Toolbar",{id:this.id+"navToolbar",cls:"bio-toolbar",region:"north",border:!0,height:35,items:[{id:this.id+"speciesMenuButton",text:this.speciesName,menu:this._getSpeciesMenu()},{id:this.id+"chromosomeMenuButton",
...
GenomeViewer.prototype._getZoomSlider=function(){var a=this;null==this._zoomSlider&&(this._zoomSlider=Ext.create("Ext.slider.Single",{id:this.id+"zoomSlider",width:170,minValue:0,maxValue:100,value:this.zoom,useTips:!0,increment:1,tipText:function(a){return Ext.String.format("<b>{0}%</b>",a.value)},listeners:{change:{fn:function(b,c){a._handleNavigationBar("ZOOM",c)},buffer:500}}}));return this._zoomSlider};
...
function TrackSvg(a,b){this.args=b;this.parent=a;this.y=0;this.height=25;this.width=200;this.title="track";this.renderedArea={};this.lienzo=5E5;this.pixelPosition=this.lienzo/2;this.histogramZoom=-1E3;this.titleVisibility="visible";this.closable=!0;this.types=FEATURE_TYPES;this.labelZoom=-1;if(null!=b&&(null!=b.title&&(this.title=b.title),null!=b.id&&(this.id=b.id),null!=b.type&&(this.type=b.type),null!=b.trackSvgLayout&&(this.trackSvgLayout=b.trackSvgLayout),null!=b.trackData&&(this.trackData=b.trackData),
null!=b.clase&&(this.clase=b.clase),null!=b.width&&(this.width=b.width),null!=b.height&&(this.height=b.height),null!=b.region&&(this.region=b.region),null!=b.zoom&&(this.zoom=b.zoom),null!=b.pixelBase&&(this.pixelBase=b.pixelBase),null!=b.closable&&(this.closable=b.closable),null!=b.labelZoom&&(this.labelZoom=b.labelZoom),null!=b.histogramZoom&&(this.histogramZoom=b.histogramZoom),null!=b.transcriptZoom&&(this.transcriptZoom=b.transcriptZoom),null!=b.featureTypes&&(this.featureTypes=b.featureTypes),
null!=b.titleVisibility&&(this.titleVisibility=b.titleVisibility),null!=b.visibleRange&&(this.visibleRange=b.visibleRange),null!=b.featuresRender)){switch(b.featuresRender){case "MultiFeatureRender":this.featuresRender=this.MultiFeatureRender;break;case "SequenceRender":this.featuresRender=this.SequenceRender;break;case "GeneTranscriptRender":this.featuresRender=this.GeneTranscriptRender;break;case "BamRender":this.featuresRender=this.BamRender;break;default:this.featuresRender=this.MultiFeatureRender}this.defaultRender=
this.featuresRender}this.position=this.region.center();this.rendered=!1;this.transcript=this.histogram=this.interval=this.status=null;this.chunksDisplayed={}}TrackSvg.prototype.setY=function(a){this.y=a};TrackSvg.prototype.getHeight=function(){return this.height};TrackSvg.prototype.setHeight=function(a){this.height=a;this.rendered&&(this.main.setAttribute("height",a),this.features.setAttribute("height",a),this.titlebar.setAttribute("height",a))};
TrackSvg.prototype.setWidth=function(a){this.width=a;this.rendered&&this.main.setAttribute("width",a)};TrackSvg.prototype.setLoading=function(a){a?(this.loading.setAttribute("visibility","visible"),this.status="rendering"):(this.loading.setAttribute("visibility","hidden"),this.status="ready")};TrackSvg.prototype.setFilters=function(a){this.trackData.setFilters(a);this.regionChange()};TrackSvg.prototype.getFilters=function(){return this.trackData.adapter.filters};
TrackSvg.prototype.getFiltersConfig=function(){return this.trackData.adapter.filtersConfig};TrackSvg.prototype.setOption=function(a,b){this.trackData.setOption(a,b);this.regionChange()};TrackSvg.prototype.getOptions=function(){return this.trackData.adapter.options};TrackSvg.prototype.getOptionsConfig=function(){return this.trackData.adapter.optionsConfig};
TrackSvg.prototype.cleanSvg=function(){for(console.time("-----------------------------------------empty");this.features.firstChild;)this.features.removeChild(this.features.firstChild);console.timeEnd("-----------------------------------------empty");this.chunksDisplayed={};this.renderedArea={}};TrackSvg.prototype.setTitle=function(a){this.titleText.textContent=a};TrackSvg.prototype.getTitle=function(){return this.titleText.textContent};
TrackSvg.prototype.draw=function(){var a=SVG.addChild(this.parent,"svg",{id:this.id,"class":"trackSvg",x:0,y:this.y,width:this.width,height:this.height}),b=SVG.addChild(a,"g",{"class":"trackTitle"}),c=this.title,d=SVG.addChild(b,"rect",{x:0,y:0,width:this.width,height:this.getHeight(),opacity:"0.6",fill:"transparent"}),e=SVG.addChild(b,"text",{x:4,y:14,"font-size":10,opacity:"0.4",fill:"black"});e.textContent=c;c=SVG.addChild(b,"svg",{"class":"features",x:-this.pixelPosition,width:this.lienzo,height:this.height});
this.fnTitleMouseEnter=function(){d.setAttribute("opacity","0.1");d.setAttribute("fill","gray");e.setAttribute("opacity","1.0")};this.fnTitleMouseLeave=function(){d.setAttribute("opacity","0.6");d.setAttribute("fill","transparent");e.setAttribute("opacity","0.4")};$(b).off("mouseenter");$(b).off("mouseleave");$(b).mouseenter(this.fnTitleMouseEnter);$(b).mouseleave(this.fnTitleMouseLeave);this.invalidZoomText=SVG.addChild(b,"text",{x:154,y:24,"font-size":10,opacity:"0.6",fill:"black",visibility:"hidden"});
...
x:10,y:0,width:22,height:22,visibility:"hidden"});this.main=a;this.titleGroup=b;this.titlebar=d;this.titleText=e;this.features=c;this.rendered=!0;this.status="ready"};
TrackSvg.prototype.MultiFeatureRender=function(a){var b=this._getFeaturesByChunks(a),c=this;console.time("Multirender ["+b.length+"] "+a.params.resource);for(var d=function(a){var b=a.start,d=a.end-b+1,f=c.width/2;0>d&&(d=Math.abs(d));0==d&&(d=1);var l=c.types[a.featureType];try{var m=l.getColor(a)}catch(p){console.log(p);debugger}var d=d*c.pixelBase,b=c.pixelPosition+f-(c.position-b)*c.pixelBase,o=9;if(c.zoom>c.labelZoom)try{var n=Math.max(d,8*l.getLabel(a).length)}catch(q){n=72}else n=Math.max(d,
10),o=0;for(var s=o+10,f=0,o=o+l.height;;){null==c.renderedArea[f]&&(c.renderedArea[f]=new FeatureBinarySearchTree);if(c.renderedArea[f].add({start:b,end:b+n-1})){n=SVG.addChild(c.features,"g");SVG.addChild(n,"rect",{x:b,y:f,width:d,height:l.height,stroke:"#3B0B0B","stroke-width":0.5,fill:m,cursor:"pointer"});c.zoom>c.labelZoom&&(SVG.addChild(n,"text",{i:e,x:b,y:o,"font-size":10,opacity:null,fill:"black",cursor:"pointer"}).textContent=l.getLabel(a));$(n).qtip({content:{text:l.getTipText(a),title:l.getTipTitle(a)},
position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:!1},style:{width:!0,classes:"ui-tooltip ui-tooltip-shadow"}});$(n).click(function(){c.showInfoWidget({query:a[l.infoWidgetId],feature:a,featureType:a.featureType,adapter:c.trackData.adapter})});break}f+=s;o+=s}},e=0,f=b.length;e<f;e++)d(b[e]);d=24*Object.keys(this.renderedArea).length;0<d&&this.setHeight(d+10);console.timeEnd("Multirender ["+b.length+"] "+a.params.resource)};
...
2,j=SVG.addChild(b.features,"g",{"class":"bamCoverage",cursor:"pointer"}),k=SVG.addChild(b.features,"g",{"class":"bamReads",cursor:"pointer"}),h=function(a){for(var c=a.coverage.all,d=a.coverage.a,e=a.coverage.c,f=a.coverage.g,k=a.coverage.t,l=parseInt(a.start),h=(parseInt(a.end)-l+1)*b.pixelBase,o=b.pixelBase/2-0.5,m,p=parseInt(a.start),n="",q="",s="",t="",r=0;r<c.length;r++){m=b.pixelPosition+g-(b.position-p)*b.pixelBase;xx=b.pixelPosition+g-(b.position-p)*b.pixelBase+b.pixelBase;n=n+(m+","+d[r]/
200*50+" ");n=n+(xx+","+d[r]/200*50+" ");q=q+(m+","+(e[r]+d[r])/200*50+" ");q=q+(xx+","+(e[r]+d[r])/200*50+" ");s=s+(m+","+(f[r]+e[r]+d[r])/200*50+" ");s=s+(xx+","+(f[r]+e[r]+d[r])/200*50+" ");t=t+(m+","+(k[r]+f[r]+e[r]+d[r])/200*50+" ");t=t+(xx+","+(k[r]+f[r]+e[r]+d[r])/200*50+" ");p++}d=q.split(" ").reverse().join(" ").trim();e=s.split(" ").reverse().join(" ").trim();t=t.split(" ").reverse().join(" ").trim();f=b.pixelPosition+g-(b.position-parseInt(a.start))*b.pixelBase+o;o=b.pixelPosition+g-(b.position-
parseInt(a.end))*b.pixelBase+o;SVG.addChild(j,"polyline",{points:f+",0 "+n+o+",0",fill:"green"});SVG.addChild(j,"polyline",{points:n+" "+d,fill:"blue"});SVG.addChild(j,"polyline",{points:q+" "+e,fill:"gold"});SVG.addChild(j,"polyline",{points:s+" "+t,fill:"red"});var B=SVG.addChild(j,"rect",{x:b.pixelPosition+g-(b.position-l)*b.pixelBase,y:0,width:h,height:50,opacity:"0.5",fill:"lightgray",cursor:"pointer"});$(B).qtip({content:" ",position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:false},
...
a.coverage.t[e]+"</span><br>";$(B).qtip("option","content.text",e)})},l=function(a){var c=a.unclippedStart,f=a.unclippedEnd,j=a.diff,l=b.types[a.featureType],h=l.getStrand(a),o=l.getColor(a,b.region.chromosome);if(d!=0&&e!=0&&!l.getMateUnmappedFlag(a)){Math.abs(a.inferredInsertSize)>e&&(o="maroon");Math.abs(a.inferredInsertSize)<d&&(o="navy")}f=(f-c+1)*b.pixelBase;c=b.pixelPosition+g-(b.position-c)*b.pixelBase;try{var m=Math.max(f,l.getLabel(a).length*8)}catch(p){m=72}for(var n=70;;){b.renderedArea[n]==
null&&(b.renderedArea[n]=new FeatureBinarySearchTree);if(b.renderedArea[n].add({start:c,end:c+m-1})){m=[];h=SVG.addChild(k,"polygon",{points:{Reverse:c+","+(n+l.height/2)+" "+(c+5)+","+n+" "+(c+f-5)+","+n+" "+(c+f-5)+","+(n+l.height)+" "+(c+5)+","+(n+l.height),Forward:c+","+n+" "+(c+f-5)+","+n+" "+(c+f)+","+(n+l.height/2)+" "+(c+f-5)+","+(n+l.height)+" "+c+","+(n+l.height)}[h],stroke:l.getStrokeColor(a),"stroke-width":1,fill:o,cursor:"pointer"});m.push(h);if(j!=null&&b.zoom>95){j=SVG.addChild(k,"path",
{d:Utils.genBamVariants(j,b.pixelBase,c,n),fill:"orangered"});m.push(j)}$(m).qtip({content:{text:l.getTipText(a),title:l.getTipTitle(a)},position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:false},style:{width:280,classes:"ui-tooltip ui-tooltip-shadow"}});$(m).click(function(){console.log(a);b.showInfoWidget({query:a[l.infoWidgetId],feature:a,featureType:a.featureType,adapter:b.trackData.adapter})});break}n=n+12}},m=function(a,c){var f=a.unclippedStart,j=a.unclippedEnd,l=c.unclippedStart,
h=c.unclippedEnd,m=a.diff,o=c.diff,p=b.types[a.featureType],n=b.types[c.featureType],q=p.getColor(a,b.region.chromosome),s=n.getColor(c,b.region.chromosome),t=p.getStrand(a),r=n.getStrand(c);if(d!=0&&e!=0){if(Math.abs(a.inferredInsertSize)>e)s=q="maroon";if(Math.abs(a.inferredInsertSize)<d)s=q="navy"}var y=f,A=h;l<=f&&(y=l);j>=h&&(A=j);for(var A=(A-y+1)*b.pixelBase,y=b.pixelPosition+g-(b.position-y)*b.pixelBase,j=(j-f+1)*b.pixelBase,f=b.pixelPosition+g-(b.position-f)*b.pixelBase,B=(h-l+1)*b.pixelBase,
l=b.pixelPosition+g-(b.position-l)*b.pixelBase,h=70;;){b.renderedArea[h]==null&&(b.renderedArea[h]=new FeatureBinarySearchTree);if(b.renderedArea[h].add({start:y,end:y+A-1})){A=[];y=[];q=SVG.addChild(k,"polygon",{points:{Reverse:f+","+(h+p.height/2)+" "+(f+5)+","+h+" "+(f+j-5)+","+h+" "+(f+j-5)+","+(h+p.height)+" "+(f+5)+","+(h+p.height),Forward:f+","+h+" "+(f+j-5)+","+h+" "+(f+j)+","+(h+p.height/2)+" "+(f+j-5)+","+(h+p.height)+" "+f+","+(h+p.height)}[t],stroke:p.getStrokeColor(a),"stroke-width":1,
fill:q,cursor:"pointer"});A.push(q);s=SVG.addChild(k,"polygon",{points:{Reverse:l+","+(h+n.height/2)+" "+(l+5)+","+h+" "+(l+B-5)+","+h+" "+(l+B-5)+","+(h+n.height)+" "+(l+5)+","+(h+n.height),Forward:l+","+h+" "+(l+B-5)+","+h+" "+(l+B)+","+(h+n.height/2)+" "+(l+B-5)+","+(h+n.height)+" "+l+","+(h+n.height)}[r],stroke:n.getStrokeColor(c),"stroke-width":1,fill:s,cursor:"pointer"});y.push(s);SVG.addChild(k,"line",{x1:f+j,y1:h+p.height/2,x2:l,y2:h+p.height/2,"stroke-width":"1",stroke:"gray",cursor:"pointer"});
if(b.zoom>95){if(m!=null){m=SVG.addChild(k,"path",{d:Utils.genBamVariants(m,b.pixelBase,f,h),fill:"orangered"});A.push(m)}if(o!=null){o=SVG.addChild(k,"path",{d:Utils.genBamVariants(o,b.pixelBase,l,h),fill:"orangered"});y.push(o)}}$(A).qtip({content:{text:p.getTipText(a),title:p.getTipTitle(a)},position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:false},style:{width:280,classes:"ui-tooltip ui-tooltip-shadow"}});$(A).click(function(){console.log(a);b.showInfoWidget({query:a[p.infoWidgetId],
feature:a,featureType:a.featureType,adapter:b.trackData.adapter})});$(y).qtip({content:{text:n.getTipText(c),title:n.getTipTitle(c)},position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:false},style:{width:280,classes:"ui-tooltip ui-tooltip-shadow"}});$(y).click(function(){console.log(c);b.showInfoWidget({query:c[n.infoWidgetId],feature:c,featureType:c.featureType,adapter:b.trackData.adapter})});break}h=h+12}};if(0<f.length){for(var p=0,o=f.length;p<o;p++)if(0<f[p].data.length){var n=
f[p];h(n);for(var n=n.data,q=0,s=n.length;q<s;q++){var t=n[q];if(c){var r=n[q+1];null!=r&&(t.name==r.name?(m(t,r),q++):l(t))}else l(t)}}c=24*Object.keys(this.renderedArea).length;0<c&&this.setHeight(c+10+70)}console.timeEnd("BamRender "+a.params.resource)};
TrackSvg.prototype.GeneTranscriptRender=function(a){var a=this._getFeaturesByChunks(a),b=this;console.time("GeneTranscriptRender");for(var c=function(a){var c=a.start,d=a.end-c+1,e=b.width/2,h=b.types[a.featureType],l=h.getColor(a),d=d*b.pixelBase,c=b.pixelPosition+e-(b.position-c)*b.pixelBase;try{var m=Math.max(d,8*h.getLabel(a).length)}catch(p){m=72}for(var o=0,n=10+h.height;;){null==b.renderedArea[o]&&(b.renderedArea[o]=new FeatureBinarySearchTree);var q,s=o;if(null!=a.transcripts)for(var t=0,
r=a.transcripts.length+1;t<r;t++){null==b.renderedArea[s]&&(b.renderedArea[s]=new FeatureBinarySearchTree);q=!b.renderedArea[s].contains({start:c,end:c+m-1});if(!1==q)break;s+=20}else q=b.renderedArea[o].add({start:c,end:c+m-1});if(q){q=SVG.addChild(b.features,"rect",{x:c,y:o,width:d,height:h.height,stroke:"#3B0B0B","stroke-width":0.5,fill:l,cursor:"pointer"});var v=SVG.addChild(b.features,"text",{i:t,x:c,y:n,"font-size":10,opacity:null,fill:"black",cursor:"pointer"});v.textContent=h.getLabel(a);
$([q,v]).qtip({content:{text:h.getTipText(a),title:h.getTipTitle(a)},position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:!1},style:{width:!0,classes:"ui-tooltip ui-tooltip-shadow"}});$([q,v]).click(function(){b.showInfoWidget({query:a[h.infoWidgetId],feature:a,featureType:a.featureType,adapter:b.trackData.adapter})});s=o+20;o=n+20;if(null!=a.transcripts){t=0;for(r=a.transcripts.length;t<r;t++){null==b.renderedArea[s]&&(b.renderedArea[s]=new FeatureBinarySearchTree);var u=a.transcripts[t],
v=b.pixelPosition+e-(b.position-u.start)*b.pixelBase;q=(u.end-u.start+1)*b.pixelBase;h=b.types[u.featureType];l=h.getColor(u);try{m=Math.max(d,d-(a.end-u.start)*b.pixelBase+7*h.getLabel(u).length)}catch(E){m=72}b.renderedArea[s].add({start:c,end:c+m-1});n=SVG.addChild(b.features,"g",{widgetId:u[h.infoWidgetId]});q=SVG.addChild(n,"rect",{x:v,y:s+1,width:q,height:h.height,fill:"gray",cursor:"pointer"});v=SVG.addChild(n,"text",{x:v,y:o,"font-size":10,opacity:null,fill:"black",cursor:"pointer"});v.textContent=
h.getLabel(u);$(n).qtip({content:{text:h.getTipText(u),title:h.getTipTitle(u)},position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:!1},style:{width:!0,classes:"ui-tooltip ui-tooltip-shadow"}});$(n).click(function(){var a=this.getAttribute("widgetId");b.showInfoWidget({query:a,feature:u,featureType:u.featureType,adapter:b.trackData.adapter})});q=0;for(v=a.transcripts[t].exonToTranscripts.length;q<v;q++){var n=a.transcripts[t].exonToTranscripts[q],C=b.types[n.exon.featureType],z=parseInt(n.exon.start),
w=parseInt(n.exon.end),x=b.pixelPosition+e-(b.position-z)*b.pixelBase,D=(w-z+1)*b.pixelBase,F=SVG.addChild(b.features,"g");$(F).qtip({content:{text:C.getTipText(n,u),title:C.getTipTitle(n)},position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:!1},style:{width:!0,classes:"ui-tooltip ui-tooltip-shadow"}});SVG.addChild(F,"rect",{i:t,x:x,y:s-1,width:D,height:C.height,stroke:"gray","stroke-width":1,fill:"white",cursor:"pointer"});D=x=0;u.codingRegionStart>z&&u.codingRegionStart<w?(x=parseInt(u.codingRegionStart),
D=w):u.codingRegionEnd>z&&u.codingRegionEnd<w?(x=z,D=parseInt(u.codingRegionEnd)):u.codingRegionStart<z&&u.codingRegionEnd>w&&(x=z,D=w);w=D-x;z=b.pixelPosition+e-(b.position-x)*b.pixelBase;x=(w+1)*b.pixelBase;if(0<w){SVG.addChild(F,"rect",{i:t,x:z,y:s-1,width:x,height:C.height,stroke:l,"stroke-width":1,fill:l,cursor:"pointer"});w=0;for(x=3-n.phase;w<x&&10==Math.round(b.pixelBase)&&-1!=n.phase;w++)SVG.addChild(F,"rect",{i:t,x:z+10*w,y:s-1,width:b.pixelBase,height:C.height,stroke:l,"stroke-width":1,
fill:"white",cursor:"pointer"})}}s+=20;o+=20}}break}o+=20;n+=20}},d=0,e=a.length;d<e;d++)c(a[d]);a=24*Object.keys(this.renderedArea).length;0<a&&this.setHeight(a+10);console.timeEnd("GeneTranscriptRender")};
TrackSvg.prototype.SequenceRender=function(a){console.time("Sequence render "+a.items.sequence.length);var b="16",c=1;95==this.zoom&&(b="10",c=0);this.invalidZoomText.setAttribute("visibility","hidden");for(var d=this.width/2,e=a.items.start,f=a.items.start,g=a.items.sequence,j=0;j<g.length;j++){var k=this.pixelPosition+d-(this.position-e)*this.pixelBase;e++;k=SVG.addChild(this.features,"text",{x:k+c,y:12,"font-size":b,"font-family":"Ubuntu Mono",fill:SEQUENCE_COLORS[g.charAt(j)]});k.textContent=
g.charAt(j);$(k).qtip({content:g.charAt(j)+" "+(f+j).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1,"),position:{target:"mouse",adjust:{x:15,y:0},viewport:$(window),effect:!1},style:{width:!0,classes:"ui-tooltip-light ui-tooltip-shadow"}})}console.timeEnd("Sequence render "+a.items.sequence.length);this.trackSvgLayout.setNucleotidPosition(this.position)};
TrackSvg.prototype.HistogramRender=function(a){var a=this._getFeaturesByChunks(a),b=this.width/2,c="";if(0<a.length)var d=this.pixelPosition+b-(this.position-a[0].start)*this.pixelBase,c=d+",50 ";for(var d=0,e=a.length;d<e;d++){var f=a[d],g=f.end-f.start,j=this.types[f.featureType].histogramColor,g=g*this.pixelBase,f=this.pixelPosition+b-(this.position-f.start)*this.pixelBase,k=50*a[d].value;null==a[d].value&&console.log(a[d]);c+=f+g/2+","+(50-k)+" "}0<a.length&&(d=this.pixelPosition+b-(this.position-
a[a.length-1].start)*this.pixelBase,c+=d+",50 ");SVG.addChild(this.features,"polyline",{points:c,stroke:"#000000","stroke-width":0.2,fill:j,cursor:"pointer"});this.setHeight(60)};
...
TrackSvg.prototype._getFeaturesByChunks=function(a){for(var b=a.items,c=a.params.dataType,a=a.params.chromosome,d=[],e,f,g,j,d=[],k=0,h=b.length;k<h;k++)if(!0!=this.chunksDisplayed[b[k].key+c]){for(var l=0,m=b[k][c].length;l<m;l++){e=b[k][c][l];f=!1;g=this.trackData.adapter.featureCache._getChunk(e.start);for(j=this.trackData.adapter.featureCache._getChunk(e.end);g<=j;g++)if(!0==this.chunksDisplayed[a+":"+g+c]){f=!0;break}f||d.push(e)}this.chunksDisplayed[b[k].key+c]=!0}return d};
TrackSvg.prototype._removeDisplayedChunks=function(a){for(var b=a.items,c=[],d=a.params.dataType,e=a.params.chromosome,f,g,j,k,h=[],l=0,m=b.length;l<m;l++)if(!0!=this.chunksDisplayed[b[l].key+d]){for(var h=[],p=0,o=b[l][d].length;p<o;p++){f=b[l][d][p];g=!1;j=this.trackData.adapter.featureCache._getChunk(f.start);for(k=this.trackData.adapter.featureCache._getChunk(f.end);j<=k;j++)if(!0==this.chunksDisplayed[e+":"+j+d]){g=!0;break}g||h.push(f)}this.chunksDisplayed[b[l].key+d]=!0;b[l][d]=h;c.push(b[l])}a.items=
c;return a};
function TrackSvgLayout(a,b){var c=this;this.args=b;this.id=Math.round(1E7*Math.random());this.trackSvgList=[];this.swapHash={};this.zoomOffset=0;this.parentLayout=null;this.windowSize=this.mousePosition="";this.zoomMultiplier=1;this.height=0;if(null!=b&&(null!=b.width&&(this.width=b.width),null!=b.height&&(this.height=b.height),null!=b.region&&(this.region=b.region),null!=b.zoomOffset&&(this.zoomOffset=b.zoomOffset),null!=b.zoomMultiplier&&(this.zoomMultiplier=b.zoomMultiplier),null!=b.parentLayout&&
(this.parentLayout=b.parentLayout),null!=b.genomeViewer))this.genomeViewer=b.genomeViewer;this.visualRegion=new Region;this.visualRegion.load(this.region);this._calculateMinRegion();this._calculatePixelBase();this.onReady=new Event;this.onRegionChange=new Event;this.onRegionSelect=new Event;this.onMove=new Event;this.onWindowSize=new Event;this.onMousePosition=new Event;this.onSvgRemoveTrack=new Event;this.parent=a;this.svgTop=SVG.init(a.top,{width:this.width});this.svg=SVG.init(a.track,{width:this.width,
height:this.height});var d=this.width/2;this.positionText=SVG.addChild(this.svgTop,"text",{x:d-30,y:22,"font-size":10,fill:"green"});this.nucleotidText=SVG.addChild(this.svgTop,"text",{x:d+35,y:22,"font-family":"Ubuntu Mono","font-size":13});this.firstPositionText=SVG.addChild(this.svgTop,"text",{x:0,y:22,"font-size":10,fill:"green"});this.lastPositionText=SVG.addChild(this.svgTop,"text",{x:this.width-70,y:22,"font-size":10,fill:"green"});this.viewNtsArrow=SVG.addChild(this.svgTop,"rect",{x:16,y:2,
width:this.width-32,height:10,opacity:"0.7",fill:"grey"});this.viewNtsArrowLeft=SVG.addChild(this.svgTop,"polyline",{points:"0,7 16,0 16,14",opacity:"0.7",fill:"grey"});this.viewNtsArrowRight=SVG.addChild(this.svgTop,"polyline",{points:this.width+",7 "+(this.width-16)+",0 "+(this.width-16)+",14",opacity:"0.7",fill:"grey"});this.viewNtsText=SVG.addChild(this.svgTop,"text",{x:d-30,y:11,"font-size":10,fill:"white"});this.windowSize="Window size: "+this.region.length()+" nts";this.viewNtsText.textContent=
this.windowSize;this._setTextPosition();this.currentLine=SVG.addChild(this.svg,"rect",{id:this.id+"centerLine",x:d,y:this.height,width:this.pixelBase,height:this.height,"stroke-width":"2",stroke:"orangered",opacity:"0.5",fill:"orange"});this.mouseLine=SVG.addChild(this.svg,"rect",{id:this.id+"mouseLine",x:-20,y:this.height,width:this.pixelBase,height:this.height,"stroke-width":"2",stroke:"lightgray",opacity:"0.7",fill:"gainsboro"});if(null==this.parentLayout)$(a.track).mousemove(function(b){var d=
c.region.center(),e=c.width/2,f=c.pixelBase/2,b=(b.clientX-$(a.track).offset().left-f)/c.pixelBase|0;c.mouseLine.setAttribute("x",b*c.pixelBase+e%c.pixelBase);c.mousePosition=d+b-(e/c.pixelBase|0);c.onMousePosition.notify({mousePos:c.mousePosition,baseHtml:c.getMousePosition(c.mousePosition)})}),$(this.svg).mousedown(function(a){this.setAttribute("cursor","move");var b=a.clientX,d=0;$(this).mousemove(function(a){this.setAttribute("cursor","move");a=(b-a.clientX)/c.pixelBase|0;if(a!=d){var e=d-a,f=
c.region.center()-e;0<f&&(c.region.start-=e,c.region.end-=e,c._setTextPosition(),c.onMove.notify(e),d=a,c.setNucleotidPosition(f))}})}),$(this.svg).mouseup(function(){c.mouseLine.setAttribute("visibility","visible");this.setAttribute("cursor","default");$(this).off("mousemove")}),$(this.svg).mouseleave(function(){this.setAttribute("cursor","default");$(this).off("mousemove");$("body").off("keydown")}),$(this.svg).mouseenter(function(){$("body").off("keydown");$("body").keydown(function(a){var b=0;
switch(a.keyCode){case 37:b=a.ctrlKey?Math.round(100/c.pixelBase):Math.round(10/c.pixelBase);break;case 39:b=a.ctrlKey?Math.round(-100/c.pixelBase):Math.round(-10/c.pixelBase);break;case 109:a.shiftKey&&console.log("zoom out");break;case 107:a.shiftKey&&console.log("zoom in")}0!=b&&(c.region.start-=b,c.region.end-=b,c._setTextPosition(),c.onMove.notify(b))})});else{c.parentLayout.onMove.addEventListener(function(a,b){c._setTextPosition();c.onMove.notify(b)});var e=SVG.addChild(this.svg,"rect",{x:0,
y:0,"stroke-width":"2",stroke:"deepskyblue",opacity:"0.5",fill:"honeydew"}),f,g;$(this.svg).mousedown(function(a){f=a.pageX-$(c.svg).offset().left;e.setAttribute("x",f);$(this).mousemove(function(a){g=a.pageX-$(c.svg).offset().left;g<f&&e.setAttribute("x",g);e.setAttribute("width",Math.abs(g-f));e.setAttribute("height",c.height)})});$(this.svg).mouseup(function(){e.setAttribute("width",0);e.setAttribute("height",0);$(this).off("mousemove");if(null!=f&&null!=g){var a=f/c.pixelBase,b=g/c.pixelBase,
a=a+c.visualRegion.start,b=b+c.visualRegion.start;c.region.start=parseInt(Math.min(a,b));c.region.end=parseInt(Math.max(a,b));c.onRegionSelect.notify()}});$(this.svg).mouseleave(function(){e.setAttribute("width",0);e.setAttribute("height",0);$(this).off("mousemove");g=f=null})}}TrackSvgLayout.prototype.setHeight=function(a){this.height=Math.max(a,60);this.svg.setAttribute("height",a);this.currentLine.setAttribute("height",parseInt(a));this.mouseLine.setAttribute("height",parseInt(a))};
TrackSvgLayout.prototype.setWidth=function(a){this.width=a;this._calculateMinRegion();var b=this.width/2;this.svg.setAttribute("width",a);this.svgTop.setAttribute("width",a);this.positionText.setAttribute("x",b-30);this.nucleotidText.setAttribute("x",b+35);this.lastPositionText.setAttribute("x",a-70);this.viewNtsArrow.setAttribute("width",a-32);this.viewNtsArrowRight.setAttribute("points",a+",7 "+(a-16)+",0 "+(a-16)+",14");this.viewNtsText.setAttribute("x",b-30);this.currentLine.setAttribute("x",
...
TrackSvgLayout.prototype._calculateMinRegion=function(){var a=this.region.length(),b=parseInt(this.width/Utils.getPixelBaseByZoom(100));a<b&&(a=this.region.center(),b=Math.ceil(b/2-1),this.region.start=Math.floor(a-b),this.region.end=Math.floor(a+b))};
TrackSvgLayout.prototype.setRegion=function(a){var b=this;this._calculateMinRegion();this._calculatePixelBase();this.currentLine.setAttribute("width",this.pixelBase);this.mouseLine.setAttribute("width",this.pixelBase);this.viewNtsText.textContent="Window size: "+this.region.length()+" nts";this.windowSize=this.viewNtsText.textContent;this._setTextPosition();this.onWindowSize.notify({windowSize:this.viewNtsText.textContent});if(null!=a.species)for(i in this.trackSvgList)if(this.trackSvgList[i].trackData.adapter instanceof
CellBaseAdapter||this.trackSvgList[i].trackData.adapter instanceof SequenceAdapter)this.trackSvgList[i].trackData.adapter.species=a.species,this.trackSvgList[i].trackData.adapter.clearData();this.nucleotidText.textContent="";var c=function(){var a;a:{for(i in b.trackSvgList)if("ready"!=b.trackSvgList[i].status){a=!1;break a}a=!0}a?null==b.parentLayout&&b.onReady.notify():setTimeout(c,100)};setTimeout(c,10);this.onRegionChange.notify()};TrackSvgLayout.prototype._createTrackSvg=function(){return trackSvg};
TrackSvgLayout.prototype.addTrack=function(a,b){var c=this,d=b.visibleRange;b.region=this.region;b.trackData=a;b.zoom=this.zoom;b.pixelBase=this.pixelBase;b.width=this.width;b.visibleRange=b.visibleRange;b.adapter=a.adapter;b.trackSvgLayout=this;var e=new TrackSvg(this.svg,b),f=this.trackSvgList.push(e);this.swapHash[e.id]={index:f-1,visible:!0};e.setY(this.height);e.draw();this.setHeight(this.height+e.getHeight());var g,j,k,h,l=function(){g=parseInt(c.region.start-2*c.halfVirtualBase);j=parseInt(c.region.end+
2*c.halfVirtualBase);k=parseInt(c.region.start-2*c.halfVirtualBase);h=parseInt(c.region.end+2*c.halfVirtualBase);e.pixelBase=c.pixelBase},m=function(){c.zoom<=e.histogramZoom?(e.histogram=!0,e.interval=Math.max(512,5/c.pixelBase)):e.histogram=null},p=function(){e.transcript=null!=e.transcriptZoom&&c.zoom>=e.transcriptZoom?!0:null},o=function(b){c.zoom>=d.start-c.zoomOffset&&c.zoom<=d.end?(e.setLoading(!0),a.retrieveData({chromosome:c.region.chromosome,start:k,end:h,histogram:e.histogram,interval:e.interval,
transcript:e.transcript,sender:b}),e.invalidZoomText.setAttribute("visibility","hidden")):e.invalidZoomText.setAttribute("visibility","visible")};e.getData=function(a,b){e.featuresRender=!0==b.params.histogram?e.HistogramRender:e.defaultRender;c.setHeight(c.height-e.getHeight());e.featuresRender(b);e.setLoading(!1);c.setHeight(c.height+e.getHeight());c._redraw()};e.onGetDataIdx=a.adapter.onGetData.addEventListener(e.getData);m();p();l();o("firstLoad");e.regionChange=function(){e.pixelBase=c.pixelBase;
e.zoom=c.zoom;e.position=e.region.center();m();p();e.cleanSvg();l();o("onRegionChange")};e.onRegionChangeIdx=this.onRegionChange.addEventListener(e.regionChange);e.move=function(b,f){e.position=c.region.center();var l=f*c.pixelBase;e.pixelPosition-=l;l=parseFloat(e.features.getAttribute("x"))+l;e.features.setAttribute("x",l);k=parseInt(e.region.start-c.halfVirtualBase);virtualEnd=parseInt(e.region.end+c.halfVirtualBase);if(c.zoom>=d.start&&c.zoom<=d.end&&(0<f&&k<g&&(a.retrieveData({chromosome:c.region.chromosome,
start:parseInt(g-c.halfVirtualBase),end:g,histogram:e.histogram,interval:e.interval,transcript:e.transcript,sender:"onMove"}),g=parseInt(g-c.halfVirtualBase)),0>f&&virtualEnd>j))a.retrieveData({chromosome:c.region.chromosome,start:j,end:parseInt(j+c.halfVirtualBase),histogram:e.histogram,interval:e.interval,transcript:e.transcript,sender:"onMove"}),j=parseInt(j+c.halfVirtualBase)};e.onMoveIdx=this.onMove.addEventListener(e.move)};
...
TrackSvgLayout.prototype.restoreTrack=function(a,b){a.region=this.region;a.zoom=this.zoom;a.pixelBase=this.pixelBase;a.width=this.width;var c=this.trackSvgList.push(a);this.swapHash[a.id]={index:c-1,visible:!0};a.setY(this.height);a.draw();this.setHeight(this.height+a.getHeight());a.onRegionChangeIdx=this.onRegionChange.addEventListener(a.regionChange);a.onMoveIdx=this.onMove.addEventListener(a.move);a.regionChange();null!=b&&this.setTrackIndex(a.id,b)};
TrackSvgLayout.prototype._redraw=function(){for(var a=null,b=0,c=0;c<this.trackSvgList.length;c++)a=this.trackSvgList[c],this.swapHash[a.id].visible&&(a.main.setAttribute("y",b),b+=a.getHeight())};
TrackSvgLayout.prototype._reallocateAbove=function(a){a=this.swapHash[a].index;console.log(a+" wants to move up");if(0<a){var b=this.trackSvgList[a-1],c=this.trackSvgList[a],d=parseInt(b.main.getAttribute("y")),e=parseInt(c.main.getAttribute("height"));b.main.setAttribute("y",d+e);c.main.setAttribute("y",d);this.trackSvgList[a]=b;this.trackSvgList[a-1]=c;this.swapHash[b.id].index=a;this.swapHash[c.id].index=a-1}else console.log("is at top")};
...
TrackSvgLayout.prototype.setTrackIndex=function(a,b){var c=this.trackSvgList.splice(this.swapHash[a].index,1)[0];this.trackSvgList.splice(b,0,c);for(c=0;c<this.trackSvgList.length;c++)this.swapHash[this.trackSvgList[c].id].index=c;this._redraw()};TrackSvgLayout.prototype.scrollToTrack=function(a){a=this.swapHash[a];null!=a&&(a=this.trackSvgList[a.index],$(this.svg).parent().parent().scrollTop(a.main.getAttribute("y")))};
TrackSvgLayout.prototype._hideTrack=function(a){this.swapHash[a].visible=!1;a=this.trackSvgList[this.swapHash[a].index];this.svg.removeChild(a.main);this.setHeight(this.height-a.getHeight());this._redraw()};TrackSvgLayout.prototype._showTrack=function(a){this.swapHash[a].visible=!0;a=this.trackSvgList[this.swapHash[a].index];this.svg.appendChild(a.main);this.setHeight(this.height+a.getHeight());this._redraw()};
TrackSvgLayout.prototype._calculatePixelBase=function(){this.pixelBase=this.width/this.region.length();this.pixelBase/=this.zoomMultiplier;this.pixelBase=Math.max(this.pixelBase,10/Math.pow(2,20));this.halfVirtualBase=3*this.width/2/this.pixelBase;this.zoom=Math.round(Utils.getZoomByPixelBase(this.pixelBase))};
TrackSvgLayout.prototype._setTextPosition=function(){var a=this.region.center(),b=parseInt(this.width/this.pixelBase),b=Math.ceil(b/2-1);this.visualRegion.start=Math.floor(a-b);this.visualRegion.end=Math.floor(a+b-1);this.positionText.textContent=Utils.formatNumber(a);this.firstPositionText.textContent=Utils.formatNumber(this.visualRegion.start);this.lastPositionText.textContent=Utils.formatNumber(this.visualRegion.end);this.viewNtsText.textContent="Window size: "+this.visualRegion.length()+" nts";
this.windowSize=this.viewNtsText.textContent};TrackSvgLayout.prototype.getTrackSvgById=function(a){return null!=this.swapHash[a]?this.trackSvgList[this.swapHash[a].index]:null};TrackSvgLayout.prototype.getMousePosition=function(a){a=this.getSequenceNucleotid(a);return'<span style="font-family: Ubuntu Mono;font-size:19px;color:'+SEQUENCE_COLORS[a]+'">'+a+"</span>"};
TrackSvgLayout.prototype.getSequenceNucleotid=function(a){var b=this.getTrackSvgById(1);return null!=b&&this.zoom>=b.visibleRange.start-this.zoomOffset&&this.zoom<=b.visibleRange.end?b.trackData.adapter.getNucleotidByPosition({start:a,end:a,chromosome:this.region.chromosome}):""};TrackSvgLayout.prototype.setNucleotidPosition=function(a){a=this.getSequenceNucleotid(a);this.nucleotidText.setAttribute("fill",SEQUENCE_COLORS[a]);this.nucleotidText.textContent=a};
function TrackData(a,b){this.id=a;if(null!=b&&(null!=b.adapter&&(this.adapter=b.adapter),null!=b.gzip))this.gzip=b.gzip}TrackData.prototype.retrieveData=function(a){this.adapter.getData(a)};TrackData.prototype.setFilters=function(a){this.adapter.setFilters(a)};TrackData.prototype.setOption=function(a,b){this.adapter.setOption(a,b)};
function TrackSettingsWidget(a){this.id="TrackSettingsWidget"+Math.round(1E4*Math.random());if(null!=a&&(null!=a.trackSvg&&(this.trackSvg=a.trackSvg),null!=a.treeRecord))this.treeRecord=a.treeRecord;this.filtersConfig=this.trackSvg.getFiltersConfig();this.filters=this.trackSvg.getFilters();null!=this.filtersConfig&&this.draw()}TrackSettingsWidget.prototype.setFilters=function(a){this.trackSvg.setFilters(a)};
TrackSettingsWidget.prototype.draw=function(){for(var a=this,b=[],c=[],d=0;d<this.filtersConfig.length;d++){var e=this.filtersConfig[d].text,f=this.filtersConfig[d].name,g=[],j;null!=this.filters[f]?j=!1:j=!0;for(var k=0;k<this.filtersConfig[d].values.length;k++)g.push({text:this.filtersConfig[d].values[k],leaf:!0,checked:j,iconCls:"icon-blue-box"});f=Ext.create("Ext.data.TreeStore",{root:{text:f,expanded:!0,checked:j,iconCls:"icon-box",children:g},fields:["text","name"]});b.push({xtype:"treepanel",
useArrows:!0,bodyPadding:"10 0 10 0",title:e,border:!1,store:f,listeners:{checkchange:function(a,b){a.isRoot()&&a.eachChild(function(a){a.set("checked",b)})},afterrender:function(b){var b=b.getStore().getRootNode(),c=b.get("text");if(null!=a.filters[c])for(var d=0;d<a.filters[c].length;d++){var e=b.findChild("text",a.filters[c][d]);e.set("checked",!0);e.save}}}});c.push(f)}d=Ext.create("Ext.panel.Panel",{title:"Display settings",bodyPadding:10,items:[{xtype:"textfield",value:a.trackSvg.getTitle(),
fieldLabel:"TrackName",allowBlank:!1,listeners:{change:function(b,c){b.isValid()&&(a.trackSvg.setTitle(c),a.treeRecord.set("text",c),a.treeRecord.save())}}}]});b=Ext.create("Ext.tab.Panel",{title:"Filters",items:b});Ext.create("Ext.window.Window",{id:this.id+"window",title:"Settings",width:500,modal:!0,items:[d,b],buttons:[{text:"Ok",id:this.id+"okButton",handler:function(){for(var b={},d=0;d<c.length;d++){var e=c[d].getRootNode(),f=e.get("text"),g=[],j=0;e.eachChild(function(a){j++;a.data.checked&&
g.push(a.get("text"))});g.length==j&&(g=[]);b[f]=g}console.log(b);a.setFilters(b);Ext.getCmp(a.id+"window").destroy()}},{text:"Cancel",handler:function(){a.trackSvg.setTitle(h);a.treeRecord.set("text",h);a.treeRecord.save();Ext.getCmp(a.id+"window").destroy()}}]}).show();var h=a.trackSvg.getTitle()};
...
FeatureCache.prototype.putFeaturesByRegion=function(a,b,c,d){var e,f,g,j,k;f=this._getChunk(b.start);g=this._getChunk(b.end);for(var h=f;h<=g;h++)e=b.chromosome+":"+h,null==this.cache[e]&&(this.cache[e]={},this.cache[e].key=e),null==this.cache[e][d]&&(this.cache[e][d]=[]);a.constructor!=Array&&(a=[a]);for(var l=0,m=a.length;l<m;l++){k=a[l];k.featureType=c;e=this._getChunk(k.start);j=this._getChunk(k.end);k=this.gzip?RawDeflate.deflate(JSON.stringify(k)):k;for(h=e;h<=j;h++)h>=f&&h<=g&&(e=b.chromosome+
":"+h,this.cache[e][d].push(k))}};FeatureCache.prototype.putFeatures=function(a,b){var c,d,e;a.constructor!=Array&&(a=[a]);for(var f=0,g=a.length;f<g;f++){c=a[f];d=this._getChunk(c.start);e=this._getChunk(c.end);for(var j=d;j<=e;j++)d=c.chromosome+":"+j,null==this.cache[d]&&(this.cache[d]=[],this.cache[d].key=d),null==this.cache[d][b]&&(this.cache[d][b]=[]),this.gzip?this.cache[d][b].push(RawDeflate.deflate(JSON.stringify(c))):this.cache[d][b].push(c)}};
...
acen:"blue"};this.data=null}ChromosomeWidget.prototype.setWidth=function(a){this.width=a;this.svg.setAttribute("width",a);for(this.tracksViewedRegion=this.width/Utils.getPixelBaseByZoom(this.zoom);this.svg.firstChild;)this.svg.removeChild(this.svg.firstChild);this._drawSvg(this.data)};
ChromosomeWidget.prototype.drawChromosome=function(){var a=this,b=new CellBaseManager(this.species);b.success.addEventListener(function(b,d){a.data=d;a._drawSvg(d)});b.get("genomic","region",this.region.chromosome,"cytoband");this.lastChromosome=this.region.chromosome};
ChromosomeWidget.prototype._drawSvg=function(a){var b=this;this.chromosomeLength=a.result[0][a.result[0].length-1].end;b.pixelBase=(b.width-40)/this.chromosomeLength;var c=20,d=!0,e=b.region.center()*b.pixelBase+20,f=SVG.addChild(b.svg,"g",{cursor:"pointer"}),g=SVG.addChild(this.svg,"rect",{x:0,y:2,"stroke-width":"2",stroke:"deepskyblue",opacity:"0.5",fill:"honeydew"});$(this.svg).off("contextmenu");$(this.svg).off("mousedown");$(this.svg).off("mouseup");$(this.svg).off("mousemove");$(this.svg).off("mouseleave");
$(this.svg).contextmenu(function(a){a.preventDefault()});var j=!1,k=!1,h=!1,l,m,p;$(this.svg).mousedown(function(a){l=a.pageX-$(b.svg).offset().left;g.setAttribute("x",l);p=b.positionBox.getAttribute("x");$(this).mousemove(function(a){m=a.pageX-$(b.svg).offset().left;!1==j&&!1==k?(h=!0,m<l&&g.setAttribute("x",m),g.setAttribute("width",Math.abs(m-l)),g.setAttribute("height",b.height-3)):!1==h&&(k=!0,a=b.positionBox.getAttribute("width"),b.positionBox.setAttribute("x",m-a/2))})});$(this.svg).mouseup(function(){$(this).off("mousemove");
if(null!=l)if(null!=m)if(!1==j&&!1==k){var a=(l-20)/b.pixelBase,c=(m-20)/b.pixelBase;b.region.start=parseInt(Math.min(a,c));b.region.end=parseInt(Math.max(a,c));var d=Math.abs(l-m);b.positionBox.setAttribute("width",d);b.positionBox.setAttribute("x",Math.abs((l+m)/2)-d/2);b.onClick.notify();h=!1}else d=b.positionBox.getAttribute("width"),a=m-d/2,c=m+d/2,a=(a-20)/b.pixelBase,c=(c-20)/b.pixelBase,b.region.start=Math.round(a),b.region.end=Math.round(c),b.positionBox.setAttribute("x",m-d/2),b.onClick.notify(),
k=!1;else d=b.positionBox.getAttribute("width"),a=l-d/2,c=l+d/2,a=(a-20)/b.pixelBase,c=(c-20)/b.pixelBase,b.region.start=Math.round(a),b.region.end=Math.round(c),b.positionBox.setAttribute("x",l-d/2),b.onClick.notify();g.setAttribute("width",0);g.setAttribute("height",0);m=l=null;p=b.positionBox.getAttribute("x")});$(this.svg).mouseleave(function(){$(this).off("mousemove");null!=p&&b.positionBox.setAttribute("x",p);g.setAttribute("width",0);g.setAttribute("height",0);p=m=l=null;h=k=j=!1});for(var o=
0;o<a.result[0].length;o++){var n=b.pixelBase*(a.result[0][o].end-a.result[0][o].start),q=b.colors[a.result[0][o].stain];null==q&&(q="purple");var s=a.result[0][o].cytoband,t=c+n/2;if("acen"==a.result[0][o].stain){var r="",r=c+n;d?(r=c+",10 "+t+",10 "+r+",19 "+t+",28 "+c+",28",d=!1):r=c+",19 "+t+",10 "+r+",10 "+r+",28 "+t+",28";SVG.addChild(f,"polyline",{points:r,stroke:"black",opacity:0.8,fill:q})}else SVG.addChild(f,"rect",{x:c,y:10,width:n,height:18,stroke:"black",opacity:0.8,fill:q});SVG.addChild(f,
"text",{x:t,y:30,"font-size":10,transform:"rotate(90, "+t+", 30)",fill:"black"}).textContent=s;c+=n}a=b.region.length()*b.pixelBase;this.positionBox=SVG.addChild(f,"rect",{x:e-a/2,y:2,width:a,height:b.height-3,stroke:"orangered","stroke-width":2,opacity:0.5,fill:"navajowhite"});$(this.positionBox).off("mouseenter");$(this.positionBox).off("mouseleave");$(this.positionBox).mouseenter(function(){!1==h&&(j=!0)});$(this.positionBox).mouseleave(function(){j=!1})};
...
JSON.parse(a);c.chroLength=c.d[0][c.d[0].length-1].end;c.pixelRatio=c.chroLength/c.circleLength;$(c.mySvg).click(function(a){var d,k,h,l;d=c.coord_x;k=c.radius+c.coord_y+c.stroke_width/2;h=c.coord_x;l=c.radius+c.coord_y-c.stroke_width/2;d=Math.sqrt(Math.pow(d-c.coord_x,2)+Math.pow(k-c.coord_y,2));h=Math.sqrt(Math.pow(h-c.coord_x,2)+Math.pow(l-c.coord_y,2));l=Math.sqrt(Math.pow(a.clientX-c.coord_x,2)+Math.pow(a.clientY-c.coord_y,2));k=!1;l>=h&&l<=d&&(k=!0);if(k){c.angle_click=0;a.clientX>c.coord_x&&
...
"chromosome")};
KaryotypeWidget.prototype._drawSvg=function(a,b){for(var c=this,d=20,e=c.width/a.length,f=0,g=0,j=a.length;g<j;g++){var k=b.result[g][b.result[g].length-1].end;k>f&&(f=k)}c.pixelBase=(c.height-10)/f;c.chrOffsetY={};c.chrOffsetX={};g=0;for(j=a.length;g<j;g++){k=b.result[g][0].chromosome;chrSize=b.result[g][b.result[g].length-1].end*c.pixelBase;var h=2+f*c.pixelBase-chrSize;c.chrOffsetY[k]=h;var l=!0,m=c.region.center()*c.pixelBase,p=SVG.addChild(c.svg,"g",{cursor:"pointer",chr:a[g]});$(p).click(function(a){var b=
this.getAttribute("chr"),a=a.pageY-$(c.svg).offset().top;c.positionBox.setAttribute("x1",c.chrOffsetX[b]-10);c.positionBox.setAttribute("x2",c.chrOffsetX[b]+23);c.positionBox.setAttribute("y1",a);c.positionBox.setAttribute("y2",a);a=parseInt((a-c.chrOffsetY[b])/c.pixelBase);c.region.chromosome=b;c.region.start=a;c.region.end=a;c.onClick.notify(c.region)});for(var o=0,n=b.result[g].length;o<n;o++){var q=c.pixelBase*(b.result[g][o].end-b.result[g][o].start),s=c.colors[b.result[g][o].stain];null==s&&
(s="purple");if("acen"==b.result[g][o].stain){var t="",t=d+6.5,r=h+q/2,v=d+13,u=h+q;l?(t=d+","+h+" "+v+","+h+" "+v+","+r+" "+t+","+u+" "+d+","+r,l=!1):t=d+","+u+" "+d+","+r+" "+t+","+h+" "+v+","+r+" "+v+","+u;SVG.addChild(p,"polyline",{points:t,stroke:"black",opacity:0.8,fill:s})}else SVG.addChild(p,"rect",{x:d,y:h,width:13,height:q,stroke:"grey",opacity:0.8,fill:s});h+=q}SVG.addChild(c.svg,"text",{x:d+1,y:c.height,"font-size":9,fill:"black"}).textContent=k;c.chrOffsetX[k]=d;d+=e}c.positionBox=SVG.addChild(c.svg,
"line",{x1:c.chrOffsetX[c.region.chromosome]-10,y1:m+c.chrOffsetY[c.region.chromosome],x2:c.chrOffsetX[c.region.chromosome]+23,y2:m+c.chrOffsetY[c.region.chromosome],stroke:"orangered","stroke-width":2,opacity:0.5});c.rendered=!0;c.afterRender.notify()};
...
function CellBaseAdapter(a){this.host=null;this.gzip=!0;this.filters={};this.options={};this.params={};if(null!=a){null!=a.host&&(this.host=a.host);null!=a.species&&(this.species=a.species);null!=a.category&&(this.category=a.category);null!=a.subCategory&&(this.subCategory=a.subCategory);null!=a.resource&&(this.resource=a.resource);if(null!=a.featureCache)var b=a.featureCache;null!=a.params&&(this.params=a.params);null!=a.filters&&(this.filters=a.filters);null!=a.options&&(this.options=a.options);
if(null!=a.featureConfig&&(null!=a.featureConfig.filters&&(this.filtersConfig=a.featureConfig.filters),null!=a.featureConfig.options)){this.optionsConfig=a.featureConfig.options;for(a=0;a<this.optionsConfig.length;a++)!0==this.optionsConfig[a].checked&&(this.options[this.optionsConfig[a].name]=!0,this.params[this.optionsConfig[a].name]=!0)}}this.featureCache=new FeatureCache(b);this.onGetData=new Event}CellBaseAdapter.prototype.clearData=function(){this.featureCache.clear()};
...
g=[],j=[];e<=f;e++){var k=a.chromosome+":"+e;null==this.featureCache.cache[k]||null==this.featureCache.cache[k][d]?g.push(e):(k=this.featureCache.getFeatureChunk(k),j.push(k))}d=new CellBaseManager(this.species,{host:this.host});d.success.addEventListener(function(a,d){var e="data";d.params.histogram&&(e="histogram"+d.params.interval);d.params.transcript&&(e="withTranscripts");if(d.params.histogram==true)d.result=[d.result];for(var f=[],g=0;g<d.query.length;g++){var l=d.query[g].split(":"),h=l[1].split("-");
f.push({chromosome:l[0],start:h[0],end:h[1]})}for(g=0;g<d.result.length;g++){d.result[g].constructor!=Array&&(d.result[g]=[d.result[g]]);if(d.resource=="gene"&&d.params.transcript!=null){l=0;for(h=d.result[g].length;l<h;l++)for(var k=0,m=d.result[g][l].transcripts.length;k<m;k++){d.result[g][l].transcripts[k].featureType="transcript";for(var E=0,C=d.result[g][l].transcripts[k].exonToTranscripts.length;E<C;E++)d.result[g][l].transcripts[k].exonToTranscripts[E].exon.featureType="exon"}}console.time(c.resource+
" save "+b);c.featureCache.putFeaturesByRegion(d.result[g],f[g],d.resource,e);l=c.featureCache.getFeatureChunksByRegion(f[g]);console.timeEnd(c.resource+" save "+b);l!=null&&(j=j.concat(l))}j.length>0&&c.onGetData.notify({items:j,params:c.params,cached:false});console.timeEnd(c.resource+" get and save "+b)});var f=[],h=k=!0;if(0<g.length){for(e=0;e<g.length;e++){if(k)var l=parseInt(g[e]*this.featureCache.chunkSize),k=!1;if(h)var m=parseInt(g[e]*this.featureCache.chunkSize+this.featureCache.chunkSize-
1),h=!1;null!=g[e+1]?g[e]+1!=g[e+1]&&(k=a.chromosome+":"+l+"-"+m,f.push(k),k=!0):(k=a.chromosome+":"+l+"-"+m,f.push(k),k=!0);h=!0}console.time(c.resource+" get and save "+b);d.get(this.category,this.subCategory,f,this.resource,this.params)}else 0<j.length&&this.onGetData.notify({items:j,params:this.params})};FileDataSource.prototype.fetch=DataSource.prototype.fetch;function FileDataSource(a){DataSource.prototype.constructor.call(this);this.file=a;this.success=new Event;this.error=new Event}
...
function StringDataSource(a){DataSource.prototype.constructor.call(this);this.str=a;this.success=new Event}StringDataSource.prototype.fetch=function(a){if(a)this.success.notify(this.str);else return this.str};UrlDataSource.prototype.fetch=DataSource.prototype.fetch;
...
GFF3DataAdapter.prototype.parse=function(a,b){for(var c=a.split("\n"),d=0;d<c.length;d++){var e=c[d].replace(/^\s+|\s+$/g,"");if(null!=e&&0<e.length){var f=e.split("\t"),e=f[0].replace("chr","");if(e==b.chromosome){for(var g=e,j=f[2],k=parseInt(f[3]),h=parseInt(f[4]),l=f[5],m=f[6],p=f[7],f=f[8].split(";"),o={},n=0,q=f.length;n<q;n++){var s=f[n].split("=");o[s[0]]=s[1]}this.featureCache.putFeatures({chromosome:g,label:j,start:k,end:h,score:l,strand:m,frame:p,attributes:o,featureType:"gff3"},"data");
...
GTFDataAdapter.prototype.parse=function(a,b){for(var c=a.split("\n"),d=0;d<c.length;d++){var e=c[d].replace(/^\s+|\s+$/g,"");if(null!=e&&0<e.length){var f=e.split("\t"),e=f[0].replace("chr","");if(e==b.chromosome){for(var g=e,j=f[2],k=parseInt(f[3]),h=parseInt(f[4]),l=f[5],m=f[6],p=f[7],f=f[8].split(";"),o={},n=0,q=f.length;n<q;n++){var s=f[n].split("=");o[s[0]]=s[1]}this.featureCache.putFeatures({chromosome:g,label:j,start:k,end:h,score:l,strand:m,frame:p,attributes:o,featureType:"gtf"},"data");
...
DasAdapter.prototype.getData=function(a){var b=this;this.params.histogram=a.histogram;this.params.interval=a.interval;this.params.transcript=a.transcript;1>a.start&&(a.start=1);3E8<a.end&&(a.end=3E8);var c="data";a.histogram&&(c="histogram"+a.interval);this.params.dataType=c;for(var d=this.featureCache._getChunk(a.start),e=this.featureCache._getChunk(a.end),f=[],g=[];d<=e;d++){var j=a.chromosome+":"+d;null==this.featureCache.cache[j]||null==this.featureCache.cache[j][c]?f.push(d):(j=this.featureCache.getFeatureChunk(j),
g.push(j))}0<g.length&&this.onGetData.notify({items:g,params:this.params,cached:!0});g=e=!0;if(0<f.length)for(d=0;d<f.length;d++){j=null;if(e)var k=parseInt(f[d]*this.featureCache.chunkSize),e=!1;if(g)var h=parseInt(f[d]*this.featureCache.chunkSize+this.featureCache.chunkSize-1),g=!1;null!=f[d+1]?f[d]+1!=f[d+1]&&(j=a.chromosome+":"+k+","+h,e=!0):(j=a.chromosome+":"+k+","+h,e=!0);g=!0;j&&(j=this.proxy+this.url+"?segment="+j,console.log("fullURL: "+j),$.ajax({url:j,type:"GET",dataType:"xml",error:function(){alert("error");
...
0;g<d.dasgff.gff.segment[f].feature.length;g++){d.dasgff.gff.segment[f].feature[g].chromosome=a.chromosome;e.push(d.dasgff.gff.segment[f].feature[g])}else e.push([]);d={chromosome:a.chromosome,start:k,end:h};b.featureCache.putFeaturesByRegion(e,d,"das",c);console.log(b.featureCache.cache);e=b.featureCache.getFeatureChunksByRegion(d);e!=null&&b.onGetData.notify({items:e,params:b.params,cached:false})}}}))}};
...
function SequenceAdapter(a){this.host=null;this.gzip=!0;this.params={};if(null!=a&&(null!=a.host&&(this.host=a.host),null!=a.species&&(this.species=a.species),null!=a.category&&(this.category=a.category),null!=a.subCategory&&(this.subCategory=a.subCategory),null!=a.resource&&(this.resource=a.resource),null!=a.params))this.params=a.params;this.onGetData=new Event;this.sequence={};this.start={};this.end={}}SequenceAdapter.prototype.clearData=function(){this.sequence={};this.start={};this.end={}};
SequenceAdapter.prototype.getData=function(a){var b=this;this.sender=a.sender;var c=a.chromosome;1>a.start&&(a.start=1);3E8<a.end&&(a.end=3E8);(a.start<this.start[c]-5E3||a.end>this.end[c]+5E3)&&this.clearData();this.params.histogram=a.histogram;this.params.interval=a.interval;this.params.transcript=a.transcript;this.params.chromosome=a.chromosome;this.params.resource=this.resource;a=this._getSequenceQuery(a);""!=a?(c=new CellBaseManager(this.species,{host:this.host}),c.success.addEventListener(function(a,
c){b._processSequenceQuery(c,true)}),c.get(this.category,this.subCategory,a,this.resource,this.params)):"onMove"!=this.sender&&this.onGetData.notify({items:{sequence:this.sequence[c],start:this.start[c],end:this.end[c]},params:this.params})};
SequenceAdapter.prototype._getSequenceQuery=function(a){var b=a.chromosome,c,d,e=[];if(null==this.start[b]&&null==this.end[b])this.start[b]=a.start,this.end[b]=a.end,c=a.start,d=a.end,e.push(b+":"+c+"-"+d);else if(a.start<=this.start[b]&&(c=a.start,d=this.start[b]-1,this.start[b]=c,c=a.chromosome+":"+c+"-"+d,e.push(c)),a.end>=this.end[b])d=a.end,c=this.end[b]+1,this.end[b]=d,c=a.chromosome+":"+c+"-"+d,e.push(c);return e.toString()};
SequenceAdapter.prototype._processSequenceQuery=function(a,b){for(var c=a.result,d=a.params,e=a.params.chromosome,f=0;f<c.length;f++){var g=a.query[f].split(":")[1].split("-"),j=parseInt(g[0]),g=parseInt(g[1]);this.sequence[e]=null==this.sequence[e]?c[f].sequence:j==this.start[e]?c[f].sequence+this.sequence[e]:this.sequence[e]+c[f].sequence;"onMove"==this.sender&&!0==b&&this.onGetData.notify({items:{sequence:c[f].sequence,start:j,end:g},params:d})}"onMove"!=this.sender&&!0==b&&this.onGetData.notify({items:{sequence:this.sequence[e],
start:this.start[e],end:this.end[e]},params:d})};SequenceAdapter.prototype.getNucleotidByPosition=function(a){var b=this._getSequenceQuery(a),c=a.chromosome;""!=b&&(b=(new CellBaseManager(this.species,{host:this.host,async:!1})).get(this.category,this.subCategory,b,this.resource,this.params),this._processSequenceQuery(b));if(null!=this.sequence[c])return this.sequence[c].substr(a.start-this.start[c],1);console.log("SequenceRender: this.sequence[chromosome] is undefined");return""};
function Region(a){this.chromosome=this.end=this.start=null;null!=a&&(null!=a.start&&(this.start=a.start),null!=a.end&&(this.end=a.end),null!=a.chromosome&&(this.chromosome=a.chromosome),null!=a.str&&this.parse(a.str))}Region.prototype.parse=function(a){a=a.split(":");if(2==a.length){var b=a[1].split("-");this.chromosome=a[0];this.start=parseInt(b[0]);this.end=2==b.length?parseInt(b[1]):this.start}};Region.prototype.load=function(a){this.start=a.start;this.end=a.end;this.chromosome=a.chromosome};
Region.prototype.center=function(){return this.start+Math.floor(this.length()/2)};Region.prototype.length=function(){return this.end-this.start+1};Region.prototype.toString=function(a){return!0==a?this.chromosome+":"+Utils.formatNumber(this.start)+"-"+Utils.formatNumber(this.end):this.chromosome+":"+this.start+"-"+this.end};
...
OpencgaAdapter.prototype.getData=function(a){var b=this;this.params.histogram=a.histogram;this.params.interval=a.interval;this.params.transcript=a.transcript;1>a.start&&(a.start=1);3E8<a.end&&(a.end=3E8);var c="data";a.histogram&&(c="histogram"+a.interval);for(var d=this.featureCache._getChunk(a.start),e=this.featureCache._getChunk(a.end),f=[],g=[];d<=e;d++){var j=a.chromosome+":"+d;null==this.featureCache.cache[j]||null==this.featureCache.cache[j][c]?f.push(d):(j=this.featureCache.getFeatureChunk(j,
c),g=g.concat(j))}var c=new OpencgaManager(this.host),k=0,h=[];c.onRegion.addEventListener(function(a,c){console.timeEnd("dqs");console.time("dqs-cache");var d="data";c.params.histogram&&(d="histogram"+c.params.interval);b.params.dataType=d;for(var e=c.query.split(":"),f=e[1].split("-"),e={chromosome:e[0],start:f[0],end:f[1]},f=0;f<c.result.length;f++){c.result[f].start=c.result[f].position;c.result[f].end=c.result[f].position}b.featureCache.putFeaturesByRegion(c.result,e,b.category,d);d=b.featureCache.getFeatureChunksByRegion(e,
d);console.timeEnd("dqs-cache");d!=null&&(g=g.concat(d));k==h.length&&b.onGetData.notify({items:g,params:b.params,cached:false})});j=e=!0;if(0<f.length){for(d=0;d<f.length;d++){if(e)var l=parseInt(f[d]*this.featureCache.chunkSize),e=!1;if(j)var m=parseInt(f[d]*this.featureCache.chunkSize+this.featureCache.chunkSize-1),j=!1;null!=f[d+1]?f[d]+1!=f[d+1]&&(e=a.chromosome+":"+l+"-"+m,h.push(e),e=!0):(e=a.chromosome+":"+l+"-"+m,h.push(e),e=!0);j=!0}d=0;for(a=h.length;d<a;d++)console.time("dqs"),k++,c.region($.cookie("bioinfo_account"),
$.cookie("bioinfo_sid"),"default",this.resource,h[d],this.params)}else 0<g.length&&this.onGetData.notify({items:g,params:this.params})};function BamCache(a){this.args=a;this.id=Math.round(1E7*Math.random());this.chunkSize=5E4;this.gzip=!0;this.maxSize=10485760;this.size=0;if(null!=a&&(null!=a.chunkSize&&(this.chunkSize=a.chunkSize),null!=a.gzip))this.gzip=a.gzip;this.cache={};this.maxFeaturesInterval=0;this.gzip=!1}BamCache.prototype._getChunk=function(a){return Math.floor(a/this.chunkSize)};
BamCache.prototype.getFeatureChunk=function(a){return null!=this.cache[a]?this.cache[a]:null};BamCache.prototype.getFeatureChunksByRegion=function(a){var b,c,d=[];b=this._getChunk(a.start);c=this._getChunk(a.end);for(var e=b;e<=c;e++)b=a.chromosome+":"+e,null!=this.cache[b]&&d.push(this.cache[b]);return d};
BamCache.prototype.putFeaturesByRegion=function(a,b,c,d){var e,f,g,c=a.reads;g=a.coverage;a=this._getChunk(b.start);f=this._getChunk(b.end);var j=0;console.time("BamCache.prototype.putFeaturesByRegion1");for(var k=a;k<=f;k++){e=b.chromosome+":"+k;null==this.cache[e]&&(this.cache[e]={},this.cache[e][d]=[],this.cache[e].key=e,this.cache[e].start=b.start,this.cache[e].end=b.end);var h=g.all.slice(j,j+this.chunkSize),l=g.a.slice(j,j+this.chunkSize),m=g.c.slice(j,j+this.chunkSize),p=g.g.slice(j,j+this.chunkSize),
o=g.t.slice(j,j+this.chunkSize),h={all:h,a:l,c:m,g:p,t:o};this.cache[e].coverage=this.gzip?RawDeflate.deflate(JSON.stringify(h)):h;j+=this.chunkSize}console.timeEnd("BamCache.prototype.putFeaturesByRegion1");console.time("BamCache.prototype.putFeaturesByRegion");j=0;for(h=c.length;j<h;j++){d=c[j];d.featureType="bam";e=this._getChunk(d.start);b=this._getChunk(0==d.end?d.end=-1:d.end);g=this.gzip?RawDeflate.deflate(JSON.stringify(d)):d;for(k=e;k<=b;k++)k>=a&&k<=f&&(e=d.chromosome+":"+k,this.cache[e].data.push(g))}console.timeEnd("BamCache.prototype.putFeaturesByRegion");
console.log("BamCache.prototype.putFeaturesByRegion0")};BamCache.prototype.clear=function(){this.size=0;this.cache={};console.log("bamCache cleared")};
function BamAdapter(a){this.filters={};this.options={};if("undefined"!=typeof a){this.host=a.host||this.host;this.category=a.category||this.category;this.resource=a.resource||this.resource;this.params=a.params||this.params;this.filters=a.filters||this.filters;this.options=a.options||this.options;this.species=a.species||this.species;var b=a.featureCache||{}}if(null!=a&&null!=a.featureConfig&&(null!=a.featureConfig.filters&&(this.filtersConfig=a.featureConfig.filters),null!=a.featureConfig.options)){this.optionsConfig=
a.featureConfig.options;for(a=0;a<this.optionsConfig.length;a++)!0==this.optionsConfig[a].checked&&(this.options[this.optionsConfig[a].name]=!0,this.params[this.optionsConfig[a].name]=!0)}this.featureCache=new BamCache(b);this.onGetData=new Event}BamAdapter.prototype={host:null,gzip:!0,params:{}};BamAdapter.prototype.clearData=function(){this.featureCache.clear()};
...
BamAdapter.prototype.getData=function(a){var b=this;this.params.histogram=a.histogram;this.params.interval=a.interval;this.params.transcript=a.transcript;this.params.chromosome=a.chromosome;this.params.resource=this.resource;this.params.category=this.category;this.params.species=this.species;1>a.start&&(a.start=1);3E8<a.end&&(a.end=3E8);var c="data";a.histogram&&(c="histogram"+a.interval);this.params.dataType=c;for(var d=this.featureCache._getChunk(a.start),e=this.featureCache._getChunk(a.end),f=
[],g=[];d<=e;d++){var j=a.chromosome+":"+d;null==this.featureCache.cache[j]||null==this.featureCache.cache[j][c]?f.push(d):(j=this.featureCache.getFeatureChunk(j),g.push(j))}c=new OpencgaManager(this.host);c.onRegion.addEventListener(function(a,c){var d="data";c.params.histogram&&(d="histogram"+c.params.interval);var e=c.query.split(":"),f=e[1].split("-"),e={chromosome:e[0],start:f[0],end:f[1]};b.featureCache.putFeaturesByRegion(c.result,e,c.resource,d);d=b.featureCache.getFeatureChunksByRegion(e,
d);g=g.concat(d);g.length>0&&b.onGetData.notify({items:g,params:b.params,cached:false})});var e=[],k=j=!0;if(0<f.length){for(d=0;d<f.length;d++){if(j)var h=parseInt(f[d]*this.featureCache.chunkSize),j=!1;if(k)var l=parseInt(f[d]*this.featureCache.chunkSize+this.featureCache.chunkSize-1),k=!1;null!=f[d+1]?f[d]+1!=f[d+1]&&(j=a.chromosome+":"+h+"-"+l,e.push(j),j=!0):(j=a.chromosome+":"+h+"-"+l,e.push(j),j=!0);k=!0}d=0;for(a=e.length;d<a;d++)console.time("dqs"),c.region($.cookie("bioinfo_account"),$.cookie("bioinfo_sid"),
"default",this.resource,e[d],this.params)}else 0<g.length&&this.onGetData.notify({items:g,params:this.params})};
...
"/"+this.subcategory+"/"+this.resource};this.get=function(a,b,e,f,g,j){null!=g&&(this.params=g);if(e instanceof Array)return this.originalQuery=e,this.batching=!0,this.results=[],this.getMultiple(a,b,e,f);e=new String(e);e=e.replace(/\s/g,"");this.originalQuery=g=e.split(",");if(this.maxQuery<g.length)this.batching=!0,this.getMultiple(a,b,g,f,j);else return this.batching=!1,this.getSingle(a,b,e,f,j)};this._joinToResults=function(a){this.resultsCount.push(!0);this.results[a.id]=a.data;if(this.numberQueries==
this.resultsCount.length){for(var a=[],b=0;b<this.results.length;b++)for(var e=0;e<this.results[b].length;e++)a.push(this.results[b][e]);this.success.notify({result:a,category:this.category,subcategory:this.subcategory,query:this.originalQuery,resource:this.resource,params:this.params,error:""})}};this.getSingle=function(a,b,e,f,g,j){this.category=a;this.subcategory=b;this.query=e;this.resource=f;a=this.getUrl();return this._callServer(a,g,j)};this.getMultiple=function(a,b,e,f){var g=[];if(e.length>
this.maxQuery)for(var j=0;j<e.length;j+=this.maxQuery)g.push(e.slice(j,j+this.maxQuery));else g.push(e);this.numberQueries=g.length;var k=this;this.batchSuccessed.addEventListener(function(a,b){k._joinToResults(b)});for(j=0;j<g.length;j++)this.results.push([]),this.getSingle(a,b,g[j].toString(),f,j)};this._callServer=function(a,b){var e=this;this.params.of=this.contentformat;a+=this.getQuery(this.params,a);console.log(a);if(!0==this.async)$.ajax({type:"GET",url:a,async:this.async,success:function(a){""==
...
0<c.result[e].length?!0:!1;for(var h=0;h<c.result[e].length;h++){var l=c.result[e][h];l.featureType="gene";b.karyotypeWidget.addMark(l,d[e]);f.addFeatures(l)}}b.adapter=f;b.filtersButton.enable();b.addTrackButton.enable();b.karyotypePanel.setLoading(!1);b.cbResponse=c;b.karyotypePanel.setLoading(!1)});this.karyotypePanel.setLoading("Connecting to Database");c.get("feature","gene",a.toString(),"info")}};
...
function GenomeMaps(a,b){var c=this;this.id="GenomeMaps"+Math.round(1E4*Math.random());this.suiteId=9;this.title="Genome Maps";this.description="Genomic data visualization";this.wum=!0;this.version="3.0.4";this.trackIdCounter=1;this.args=b;this.width=$(window).width();this.height=$(window).height();this.targetId=document.body;null!=a&&(this.targetId=a);if(null!=b&&(null!=b.width&&(this.width=b.width),null!=b.height&&(this.height=b.height),null!=b.wum))this.wum=b.wum;"undefined"!=typeof b&&(this.width=
b.width||this.width,this.height=b.height||this.height,this.wum=b.wum||this.wum);this.accountData=null;var d=new Region,e=$.url(),f=e.param("CELLBASE_HOST");null!=f&&(CELLBASE_HOST=f);speciesObj=DEFAULT_SPECIES;f=e.param("species");if(null!=f||""!=f)for(var g=0;g<AVAILABLE_SPECIES.length;g++)if(AVAILABLE_SPECIES[g].species==f){speciesObj=AVAILABLE_SPECIES[g];break}this.species=speciesObj.species;d.load(speciesObj.region);f=e.param("region");null!=f&&d.parse(f);f=parseInt(e.param("zoom"));if(isNaN(f)||
100<f||0>f)f=null;g=e.param("gene");null!=g&&""!=g&&d.load(this.getRegionByFeature(g,"gene"));g=e.param("snp");null!=g&&""!=g&&d.load(this.getRegionByFeature(g,"snp"));this.headerWidget=new HeaderWidget({appname:this.title,description:this.description,version:this.version,suiteId:this.suiteId,accountData:this.accountData});d.url=e.param("region");g=!1;"false"===e.param("confpanel")&&(g=!0);var j=!0;"false"===e.param("regionpanel")&&(j=!1);this.genomeViewer=new GenomeViewer(this.id+"gvDiv",speciesObj,
{region:d,version:this.version,zoom:f,confPanelCollapsed:g,regionPanelHidden:j,availableSpecies:AVAILABLE_SPECIES,height:this.height-this.headerWidget.height,width:this.width});this.headerWidget.onLogin.addEventListener(function(){Ext.example.msg("Welcome","You logged in");c.sessionInitiated()});this.headerWidget.onLogout.addEventListener(function(){Ext.example.msg("Good bye","You logged out");c.sessionFinished()});this.headerWidget.onGetAccountInfo.addEventListener(function(a,b){c.setAccountData(b)});
this._updateLocalOpencgaTracks();this.genomeViewer.onSpeciesChange.addEventListener(function(){c.headerWidget.setDescription(c.genomeViewer.speciesName);c.species=c.genomeViewer.species});$(window).smartresize(function(){c.setSize($(window).width(),$(window).height())});$(window).unload(function(){$.cookie("gm_settings",JSON.stringify({species:{name:c.genomeViewer.speciesName,species:c.genomeViewer.species,chromosome:c.genomeViewer.chromosome,position:c.genomeViewer.position}}),{expires:365})})}
GenomeMaps.prototype.sessionInitiated=function(){this.availableSt.getRootNode().findChild("id","opencga").set("text","Browse remote data")};GenomeMaps.prototype.sessionFinished=function(){this.availableSt.getRootNode().findChild("id","opencga").set("text",'Browse remote data <span class="tip">(login required)</span>');this._unloadOpencgaTracks();this.accountData=null};GenomeMaps.prototype.setAccountData=function(a){this.accountData=a;this._updateOpencgaTracks(JSON.parse(JSON.stringify(a)))};
...
GenomeMaps.prototype.addTrack=function(a,b,c,d){var e=this.genTrackId();switch(a){case "Gene/Transcript":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"gene",species:this.genomeViewer.species,featureCache:{gzip:!0,chunkSize:5E4},featureConfig:FEATURE_CONFIG.gene})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"GeneTranscriptRender",histogramZoom:20,transcriptZoom:50,height:24,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});
break;case "Cytoband":break;case "Sequence":c=new TrackData(e,{adapter:new SequenceAdapter({category:"genomic",subCategory:"region",resource:"sequence",species:this.genomeViewer.species,featureCache:{gzip:!0,chunkSize:1E3}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"SequenceRender",height:30,visibleRange:{start:100,end:100}});break;case "CpG islands":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"cpg_island",species:this.genomeViewer.species,
featureCache:{gzip:!0,chunkSize:5E4}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:10,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "SNP":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"snp",species:this.genomeViewer.species,featureCache:{gzip:!0,chunkSize:1E4},featureConfig:FEATURE_CONFIG.snp})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",
histogramZoom:70,labelZoom:80,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "Mutation":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"mutation",species:this.genomeViewer.species,featureCache:{gzip:!0,chunkSize:1E4}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:50,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "Structural variation (<20Kb)":c=
new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"structural_variation",species:this.genomeViewer.species,params:{min_length:1,max_length:2E4},featureCache:{gzip:!0,chunkSize:5E4}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:40,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "Structural variation (>20Kb)":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",
subCategory:"region",resource:"structural_variation",species:this.genomeViewer.species,params:{min_length:2E4,max_length:3E8},featureCache:{gzip:!0,chunkSize:5E6}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:40,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "miRNA targets":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"mirna_target",species:this.genomeViewer.species,
featureCache:{gzip:!0,chunkSize:1E4}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:50,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "TFBS":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"tfbs",species:this.genomeViewer.species,featureCache:{gzip:!0,chunkSize:1E4}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:50,
height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "Conserved regions":c=new TrackData(e,{adapter:new CellBaseAdapter({category:"genomic",subCategory:"region",resource:"conserved_region",species:this.genomeViewer.species,featureCache:{gzip:!0,chunkSize:1E4}})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:50,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;case "bam":c=new TrackData(e,
{adapter:new BamAdapter({category:"bam",host:d,resource:c,species:this.genomeViewer.species,featureCache:{gzip:!1,chunkSize:5E3},filters:{},options:{},featureConfig:FEATURE_CONFIG.bam})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"BamRender",histogramZoom:20,height:24,visibleRange:{start:90,end:100},featureTypes:FEATURE_TYPES});break;case "vcf":c=new TrackData(e,{adapter:new OpencgaAdapter({category:"vcf",resource:c,species:this.genomeViewer.species,featureCache:{gzip:!1,chunkSize:5E3},
filters:{},options:{},featureConfig:FEATURE_CONFIG.vcf})});this.genomeViewer.addTrack(c,{id:e,type:a,title:b,featuresRender:"MultiFeatureRender",histogramZoom:50,height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});break;default:return null}return e};
GenomeMaps.prototype.addFileTrack=function(a,b){var c=this,d=null;switch(a){case "GFF2":d=new GFFFileWidget({version:2,viewer:c.genomeViewer});break;case "GFF3":d=new GFFFileWidget({version:3,viewer:c.genomeViewer});break;case "GTF":d=new GTFFileWidget({viewer:c.genomeViewer});break;case "BED":d=new BEDFileWidget({viewer:c.genomeViewer});break;case "VCF":d=new VCFFileWidget({viewer:c.genomeViewer})}null!=d&&(d.draw(),c.wum&&(c.headerWidget.onLogin.addEventListener(function(){d.sessionInitiated()}),
c.headerWidget.onLogout.addEventListener(function(){d.sessionFinished()})),d.onOk.addEventListener(function(d,f){var g=new TrackData(f.fileName,{adapter:f.adapter}),j=c.genTrackId();c.genomeViewer.addTrack(g,{id:j,title:f.fileName,type:a,featuresRender:"MultiFeatureRender",height:150,visibleRange:{start:0,end:100},featureTypes:FEATURE_TYPES});b(a,f.fileName+"-"+j,j,true)}))};
...
GenomeMaps.prototype._loadInitialTracksConfig=function(){for(var a=TRACKS[SPECIES_TRACKS_GROUP[this.species]],b=[],c=[],d=0,e=a.length;d<e;d++){var f=[];c.push({text:a[d].category,iconCls:"icon-box",expanded:!0,children:f});for(var g=0,j=a[d].tracks.length;g<j;g++){var k=a[d].tracks[g].id,h=a[d].tracks[g].checked;f.push({text:k,iconCls:"icon-blue-box",leaf:!0});h&&(h=this.addTrack(k,k),null!=h?b.push({text:k,trackId:h,trackType:k,checked:!0,iconCls:"icon-blue-box",leaf:!0}):console.log("track type not exists in the addTrack function"))}}return{cellbaseTracks:c,
activeTracks:b}};GenomeMaps.prototype._loadInitialDasTrackConfig=function(){for(var a=DAS_TRACKS,b=[],c=0,d=a.length;c<d;c++)if(a[c].species==this.species){for(var d=0,e=a[c].categories.length;d<e;d++){var f,g,j=[];b.push({text:a[c].categories[d].name,iconCls:"icon-box",expanded:!0,children:j});for(var k=0,h=a[c].categories[d].sources.length;k<h;k++)f=a[c].categories[d].sources[k].name,g=a[c].categories[d].sources[k].url,j.push({text:f,url:g,iconCls:"icon-blue-box",leaf:!0})}break}return b};
...
title:"Options",bodyPadding:10,border:!1},{id:this.id+"trackFiltering",itemId:this.id+"trackFiltering",title:"Filtering",layout:{type:"vbox",align:"stretch"},border:!1}]}]},d={title:'<span class="">Search</span>',id:this.id+"searchSidePanel",layout:{type:"vbox",align:"stretch"},bodyPadding:"5",items:[{xtype:"tbtext",text:'<p class="">Search by any external reference:</p>'},{id:this.id+"searchTextArea",xtype:"textarea",flex:1,enableKeyEvents:!0,cls:"dis",style:"normal 6px Ubuntu Mono, arial, verdana, sans-serif",
value:"",listeners:{change:function(b){""!=b.getValue()?Ext.getCmp(a.id+"searchPanelButton").enable():Ext.getCmp(a.id+"searchPanelButton").disable()}}},{id:this.id+"searchPanelCombo",fieldLabel:"Result type",xtype:"combobox",store:{fields:["value","name"],data:[{value:"info",name:"Genes"},{value:"snp",name:"SNPs"},{value:"mutation",name:"Mutations"},{value:"transcript",name:"Transcripts"},{value:"exon",name:"Exons"}]},displayField:"name",valueField:"value",listeners:{afterrender:function(a){a.select(a.getStore().data.items[0])}}},
{id:this.id+"searchPanelButton",margin:"0 0 0 0",xtype:"button",text:"Search",disabled:!0,handler:function(){var b=Ext.getCmp(a.id+"searchResults");b.setLoading(!0);b.removeAll();var c=Ext.getCmp(a.id+"searchTextArea").getValue().trim().split("\n"),d=Ext.getCmp(a.id+"searchPanelCombo").getValue().toLowerCase(),e=new CellBaseManager(a.species);e.success.addEventListener(function(c,e){for(var g="",k=[],o=d.replace("info","gene"),n=FEATURE_TYPES[o].infoWidgetId,q=0,s=e.result.length;q<s;q++)if(0<e.result[q].length){var t=
3<e.query.length;if("snp"==o||"mutation"==o||"exon"==o){var r=Ext.create("Ext.data.Store",{fields:[n,"chromosome","start","end"],data:e.result[q],proxy:{type:"pagingmemory"},pageSize:5});k.push({xtype:"grid",store:r,hideHeaders:!0,width:250,height:160,loadMask:!0,margin:"2 0 0 0",title:'<p class="info">'+e.query[q]+"</p>",collapsible:!0,collapsed:t,titleCollapse:!0,columns:[{text:"id",dataIndex:n,width:243}],dockedItems:[{xtype:"pagingtoolbar",store:r,dock:"top",beforePageText:""}],listeners:{itemclick:function(b,
c){a.genomeViewer.region.load(c.data);a.genomeViewer.onRegionChange.notify({sender:"searchSidePanel"})}}})}else{for(var t=!1,t=[],r=new Ext.XTemplate("<p>{"+n+"}</p>"),v=0,u=e.result[q].length;v<u;v++)t.push({xtype:"box",padding:"1 5 1 10",border:1,tpl:r,data:e.result[q][v],datos:e.result[q][v],listeners:{afterrender:function(b){this.getEl().addClsOnOver("encima2");this.getEl().addCls("whiteborder");this.getEl().on("click",function(){a.genomeViewer.region.load(b.datos);a.genomeViewer.onRegionChange.notify({sender:"searchSidePanel"})})}}});
k.push({xtype:"panel",title:'<p class="info">'+e.query[q]+"</p>",margin:"2 0 0 0",collapsible:!0,collapsed:!1,titleCollapse:!0,width:250,items:t})}}else g+="&nbsp; &nbsp;"+e.query[q]+"<br>";""!=g&&(g='<p class="err">Features not found:</p>'+g);k.push({xtype:"box",padding:"15 5 2 3",border:1,html:g});b.add(k);b.setLoading(!1)});e.get("feature","gene",c,d,null)}},{xtype:"tbtext",margin:"10 0 0 0",text:'<p class="">Results:</p>'},{id:this.id+"searchResults",border:!1,autoScroll:!0,flex:3}]},b=this._createTracksTreePanel("CellBase and DAS",
[{text:"CellBase",iconCls:"icon-box",id:"cellbase",expanded:!0,children:b.cellbaseTracks},{text:"DAS",iconCls:"icon-box",id:"das",expanded:!0,children:this._loadInitialDasTrackConfig()}]),e=this._createTracksTreePanel("Import data",[{text:"Browse remote data",id:"opencga",iconCls:"icon-box",expanded:!0,children:[]},{text:'Browse local data <span class="tip">(light server required)</span>',id:"localopencga",iconCls:"icon-box",expanded:!0,children:[]},{text:"Load local data (<500MB)",id:"load",iconCls:"icon-box",
expanded:!0,children:[{text:"GFF2",iconCls:"icon-blue-box",leaf:!0},{text:"GFF3",iconCls:"icon-blue-box",leaf:!0},{text:"BED",iconCls:"icon-blue-box",leaf:!0},{text:"VCF",iconCls:"icon-blue-box",leaf:!0}]}]);return[c,b,e,d]};
GenomeMaps.prototype._createTracksTreePanel=function(a,b){var c=this,d=Ext.create("Ext.data.TreeStore",{fields:["text","id"],root:{expanded:!0,children:b}});this.availableSt=d;return{xtype:"treepanel",id:this.id+a,title:'<span class="">'+a+"</span>",bodyPadding:"10 0 0 0",useArrows:!0,rootVisible:!1,hideHeaders:!0,store:d,viewConfig:{markDirty:!1},columns:[{xtype:"treecolumn",dataIndex:"text",flex:1},{xtype:"actioncolumn",menuDisabled:!0,align:"center",width:20,icon:Utils.images.edit,renderer:function(a,
b,c){"localopencga"==c.data.id?(this.icon=Utils.images.edit,this.tooltip="Edit OpenCGA ligth server host"):this.icon=null},handler:function(a,b,c,d,k,h){"localopencga"==h.data.id&&Ext.Msg.prompt("OpenCGA light host","Please enter a new OpenCGA light host:",function(a){if("ok"==a){var b=null,a=test;$.ajax({url:a+"/admin?action=status",async:!1,success:function(a){-1!=a.indexOf("it works")&&(b=!0)}});b?(OPENCGA_LOCALHOST=a,h.set("tooltip",OPENCGA_LOCALHOST),Ext.example.msg("Cellbase Host","Host changed<br>"+
OPENCGA_LOCALHOST)):Ext.example.msg("Cellbase Host","Not found")}},null,null,OPENCGA_LOCALHOST)}},{xtype:"actioncolumn",menuDisabled:!0,align:"center",width:20,renderer:function(a,b,c){"cellbase"==c.data.id?(this.icon=Utils.images.info,this.tooltip=CELLBASE_HOST):"das"==c.data.id?(this.icon=Utils.images.info,this.tooltip="Add custom DAS track"):"opencga"==c.data.id?(this.icon=Utils.images.info,this.tooltip="OpenCGA server information link"):"localopencga"==c.data.id?(this.icon=Utils.images.info,this.tooltip=
"OpenCGA light server information link"):this.icon=this.tooltip=null},handler:function(a,b,c,d,k,h){a=h.data.id;"opencga"==a&&open("http://wiki.opencb.org/projects/visualization/doku.php?id=genome-maps:opencga_sever");"localopencga"==a&&open("http://wiki.opencb.org/projects/visualization/doku.php?id=genome-maps:opencga_light_sever")}},{xtype:"actioncolumn",menuDisabled:!0,align:"center",width:20,icon:Utils.images.add,renderer:function(a,b,c){c.isLeaf()?(this.icon=Utils.images.add,this.tooltip="Add"):
"cellbase"==c.data.id?this.icon=Utils.images.edit:"das"==c.data.id?this.icon=Utils.images.add:"localopencga"==c.data.id?(this.icon=Utils.images.refresh,this.tooltip="Refresh local files"):this.icon=null},handler:function(a,b,g,j,k,h){var l=function(a,b,d,e){c.activeSt.getRootNode().appendChild({text:b,trackId:d,trackType:a,leaf:!0,checked:!0,iconCls:"icon-blue-box"});Ext.example.msg("Track "+a,"actived");!0==e&&Ext.getCmp(c.id+"activeTracksTree").expand()},a=h.data.text,b=h.data.id;if(h.isLeaf()){if(h.isAncestor(d.getRootNode().findChild("id",
"cellbase"))&&(b=a,g=c.addTrack(b,a),null!=g?l(b,b,g,!0):console.log("track type not exists in the addTrack function")),h.isAncestor(d.getRootNode().findChild("id","das"))&&(b="das",g=c.addDASTrack(a,h.raw.url),l(b,a,g,!0)),h.isAncestor(d.getRootNode().findChild("id","load"))&&c.addFileTrack(a,l),h.isAncestor(d.getRootNode().findChild("id","opencga"))&&(b=h.raw.fileFormat,g=c.addTrack(b,a,h.raw.oid),null!=g&&l(b,a,g,!0)),h.isAncestor(d.getRootNode().findChild("id","localopencga")))b=h.raw.oid.split(".").pop(),
g=c.addTrack(b,a,h.raw.oid,OPENCGA_LOCALHOST),null!=g&&l(b,a,g,!0)}else"cellbase"==b&&Ext.Msg.prompt("Cellbase","Please enter a new Cellbase URL:",function(a,b){if("ok"==a){var c=null,d="http://"+b+"/cellbase/rest";$.ajax({url:d+"/rest/latest",async:!1,success:function(a){-1!=a.indexOf("hsa")&&(c=!0)}});c?(CELLBASE_HOST=d,h.set("tooltip",CELLBASE_HOST),Ext.example.msg("Cellbase Host","Host changed<br>"+CELLBASE_HOST)):Ext.example.msg("Cellbase Host","Not found")}}),"das"==b&&(a=new UrlWidget({title:"Add a DAS track"}),
a.onAdd.addEventListener(function(a,b){var d=c.addDASTrack(b.name,b.url);l("das",b.name+"-"+d,d,!0)}),a.draw()),"localopencga"==b&&c._updateLocalOpencgaTracks()}}]}};
GenomeMaps.prototype._loadOpencgaTracks=function(a){for(var b=0;b<a.buckets.length;b++){for(var c=[],d=0;d<a.buckets[b].objects.length;d++){var e=a.buckets[b].objects[d];if("dir"!=e.fileType&&("bam"==e.fileFormat||"tbi"==e.fileFormat))e.text=e.fileName,e.icon=Utils.images.r,e.leaf=!0,e.oid=e.id||e.oid,c.push(e)}this.availableSt.getRootNode().findChild("id","opencga").appendChild({text:a.buckets[b].name,iconCls:"icon-blue-box",expanded:!0,children:c})}};
GenomeMaps.prototype._unloadOpencgaTracks=function(){this.availableSt.getRootNode().findChild("id","opencga").removeAll()};GenomeMaps.prototype._updateOpencgaTracks=function(a){this._unloadOpencgaTracks();this._loadOpencgaTracks(a)};
GenomeMaps.prototype._updateLocalOpencgaTracks=function(){var a=this,b=new OpencgaManager(OPENCGA_LOCALHOST);b.onLocalFileList.addEventListener(function(b,d){a.availableSt.getRootNode().findChild("id","localopencga").removeAll();if("error"!=d.statusText){Ext.example.msg("Local Open CGA","loaded");a.availableSt.getRootNode().findChild("id","localopencga").set("text",'Browse local data <span class="ok">(ready)</span>');var e=JSON.parse(d);a.availableSt.getRootNode().findChild("id","localopencga").appendChild(e)}});
b.localFileList()};
GenomeMaps.prototype._loadTrackConfig=function(a){var b=a.getFiltersConfig(),c=a.getFilters();if(null!=b){for(var d=[],e=[],f=0;f<b.length;f++){var g=b[f].text,j=b[f].name,k=[],h;null!=c[j]?h=!1:h=!0;for(var l=0;l<b[f].values.length;l++)k.push({text:b[f].values[l],leaf:!0,checked:h,iconCls:"icon-blue-box"});j=Ext.create("Ext.data.TreeStore",{root:{text:j,expanded:!0,checked:h,iconCls:"icon-box",children:k},fields:["text","name"]});d.push({xtype:"treepanel",useArrows:!0,bodyPadding:"5 0 5 0",title:g,
border:0,store:j,listeners:{checkchange:function(a,b){a.isRoot()&&a.eachChild(function(a){a.set("checked",b)})},afterrender:function(a){var a=a.getStore().getRootNode(),b=a.get("text");if(null!=c[b])for(var d=0;d<c[b].length;d++){var e=a.findChild("text",c[b][d]);e.set("checked",!0);e.save}}}});e.push(j)}f=Ext.create("Ext.tab.Panel",{flex:1,plain:!0,border:0,bbar:{xtype:"toolbar",layout:{type:"hbox",pack:"center"},items:[{xtype:"button",flex:1,text:'<span class="emph">Apply filter</span>',id:this.id+
