...
#         print "JobAndDiskFileReader", self.rootdir, self.StackdriverAPIKey, self.activateStackDriver 
    ...
    def readInstances(self, InstancesFile, myDriver, disks, log, session=None):
...
#                  activateStackDriver=False
    ...
    def readInJobInfo(self, session = None):
        self.jobids = set()
        ...
        instances=self.readInstances(self.job_csv_file, self.myDriver, disks, self.log, session=session)
        existentNodes = None
